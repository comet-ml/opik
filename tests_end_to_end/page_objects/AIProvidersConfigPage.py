...
class AIProvidersConfigPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.add_provider_button = self.page.get_by_role("button", name="Add configuration").first
    ...
    def delete_provider(self, provider_name: str):
        ...
        self.page.get_by_role("row", name=provider_name).get_by_role("button", name="Actions menu").click()
