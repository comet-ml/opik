...
class PlaygroundPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.error_message = self.page.locator("text=Please select an LLM model for your prompt")
    ...
    def verify_model_selected(self, expected_model_contains=None):
        ...
        if expected_model_contains:
            ...
            assert expected_model_contains in model_text, f"Expected model to contain '{expected_model_contains}', but got '{model_text}'"
