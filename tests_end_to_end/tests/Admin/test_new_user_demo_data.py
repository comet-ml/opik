...
def test_new_user_demo_data(page: Page, temp_user_with_api_key, env_config):
    ...
    while True:
        try:
            ...
            if elapsed_time > max_wait_time:
                raise AssertionError(f"Demo data not found after {max_wait_time} seconds: {str(e)}")
    ...
    assert traces_page.get_number_of_traces_on_page() > 0, "No traces generated for demo project"
