...
export class OnlineEvaluationPage {
   ...
   *
   * An exact duplicate of `submitRuleDialog` above, which two specs landed
   * independently under two names; `submitRuleDialog` is the one that now waits
   * for the write, and collapsing the pair is an estate-wide change rather than
   * this spec's to make.
   */
