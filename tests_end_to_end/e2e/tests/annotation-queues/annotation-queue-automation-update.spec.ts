...
import type {
  AnnotationQueueAutomationRecord,
  BackendClient,
  ScoreConditionsRef,
 ...
 *
 * `max_items_in_queue` is out of scope throughout. It is present in the build at
 * the top of this stack — the caveat this file used to carry, that the field was
 * not yet in the build, no longer holds — so its interaction with the three PATCH
 * states is untested rather than untestable.
 */
...
const REPLACEMENT_AUTOMATION: AnnotationQueueAutomationRecord = {
  enabled: true,
