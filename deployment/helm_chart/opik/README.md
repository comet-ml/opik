...
| component.backend.livenessProbe.failureThreshold | int | `2` |  |
...
| component.backend.livenessProbe.periodSeconds | int | `10` |  |
| component.backend.livenessProbe.successThreshold | int | `1` |  |
...
| component.backend.readinessProbe.successThreshold | int | `1` |  |
