...
| component.python-backend.networkPolicy.engineEgress.except[0] | string | `"10.4.0.0/18"` |  |
| component.python-backend.networkPolicy.engineEgress.except[1] | string | `"10.4.64.0/18"` |  |
| component.python-backend.networkPolicy.engineEgress.except[2] | string | `"10.4.128.0/18"` |  |
| component.python-backend.networkPolicy.engineEgress.except[3] | string | `"10.100.0.0/16"` |  |
| component.python-backend.networkPolicy.engineEgress.except[4] | string | `"10.126.0.0/15"` |  |
| component.python-backend.networkPolicy.engineEgress.except[5] | string | `"10.10.0.0/16"` |  |
