...
| component.mcp.autoscaling.enabled | bool | `false` |  |
| component.mcp.backendConfigMap.enabled | bool | `false` |  |
| component.mcp.enabled | bool | `false` |  |
| component.mcp.env.OPIK_API_BASE_URL | string | `"http://opik-frontend:5173/api"` |  |
| component.mcp.env.OPIK_SELF_HOSTED | string | `"true"` |  |
| component.mcp.env.OPIK_TOOLSETS | string | `"all"` |  |
| component.mcp.env.STREAMABLE_HTTP_HOST | string | `"0.0.0.0"` |  |
| component.mcp.env.STREAMABLE_HTTP_PORT | string | `"3001"` |  |
| component.mcp.env.STREAMABLE_HTTP_REQUIRE_AUTH | string | `"true"` |  |
| component.mcp.env.STREAMABLE_HTTP_TRUST_WORKSPACE_HEADERS | string | `"false"` |  |
| component.mcp.env.STREAMABLE_HTTP_VALIDATE_REMOTE_AUTH | string | `"true"` |  |
| component.mcp.env.TRANSPORT | string | `"streamable-http"` |  |
| component.mcp.image.pullPolicy | string | `"IfNotPresent"` |  |
| component.mcp.image.repository | string | `"opik-mcp"` |  |
| component.mcp.ingress.annotations | object | `{}` |  |
| component.mcp.ingress.enabled | bool | `false` |  |
| component.mcp.ingress.hosts | list | `[]` |  |
| component.mcp.ingress.ingressClassName | string | `""` |  |
| component.mcp.ingress.tls.enabled | bool | `false` |  |
| component.mcp.ingress.tls.hosts | list | `[]` |  |
| component.mcp.ingress.tls.secretName | string | `""` |  |
| component.mcp.livenessProbe.httpGet.path | string | `"/health"` |  |
| component.mcp.livenessProbe.httpGet.port | int | `3001` |  |
| component.mcp.metrics.enabled | bool | `false` |  |
| component.mcp.podDisruptionBudget.enabled | bool | `false` |  |
| component.mcp.ports[0].containerPort | int | `3001` |  |
| component.mcp.ports[0].name | string | `"http"` |  |
| component.mcp.ports[0].protocol | string | `"TCP"` |  |
| component.mcp.readinessProbe.httpGet.path | string | `"/readyz"` |  |
| component.mcp.readinessProbe.httpGet.port | int | `3001` |  |
| component.mcp.readinessProbe.initialDelaySeconds | int | `5` |  |
| component.mcp.replicaCount | int | `1` |  |
| component.mcp.securityContext | object | `{}` |  |
| component.mcp.service.ports[0].name | string | `"http"` |  |
| component.mcp.service.ports[0].port | int | `3001` |  |
| component.mcp.service.ports[0].protocol | string | `"TCP"` |  |
| component.mcp.service.ports[0].targetPort | int | `3001` |  |
| component.mcp.service.type | string | `"ClusterIP"` |  |
| component.mcp.serviceAccount.create | bool | `true` |  |
| component.mcp.serviceAccount.name | string | `"opik-mcp"` |  |
| component.mcp.startupProbe.failureThreshold | int | `30` |  |
| component.mcp.startupProbe.httpGet.path | string | `"/healthz"` |  |
| component.mcp.startupProbe.httpGet.port | int | `3001` |  |
| component.mcp.startupProbe.periodSeconds | int | `5` |  |
