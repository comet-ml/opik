...
<a href="#🚀-what-is-opik">🚀 什么是 Opik？</a> • <a href="#🛠️-opik-server-installation">🛠️ Opik 服务端安装</a> • <a href="#💻-opik-client-sdk">💻 Opik 客户端 SDK</a> • <a href="#📝-logging-traces-with-integrations">📝 日志跟踪与集成</a><br>
<a href="#🧑‍⚖️-llm-as-a-judge-metrics">🧑‍⚖️ 作为裁判的 LLM</a> • <a href="#🔍-evaluating-your-llm-application">🔍 评估您的应用</a> • <a href="#⭐-star-us-on-github">⭐ 在 GitHub 上给我们加星</a> • <a href="#🤝-contributing">🤝 贡献指南</a>
</div>
