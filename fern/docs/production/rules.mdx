...
![Opik LLM as a Judge](file:fb87d263-d6fd-4b2f-892f-92f5e90631db)
...
<Frame>
  <img src="file:2e907cdc-2204-47c0-85a3-9b92b0a4c4e9" />
</Frame>
...
3. **Model:** The model to use to run the LLM as a Judge metric.
...
![Opik dashboard](file:e9f216e6-821b-484c-9a5c-1962bfad0c65)
