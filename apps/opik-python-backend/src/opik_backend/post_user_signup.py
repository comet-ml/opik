...
from flask import request, abort, jsonify, Blueprint, copy_current_request_context
...
async def execute():
    ...
    return await loop.run_in_executor(None, run_post_user_signup)
