...
To start tracking your watsonx LLM calls, you can use our [LiteLLM integration](/docs/tracing/integrations/litellm). You'll need to have both the `opik` and `litellm` packages installed. You can install them using pip:
...
<Frame>
  <img src="/static/img/cookbook/watsonx_trace_cookbook.png" />
</Frame>
...
<Frame>
  <img src="/static/img/cookbook/watsonx_trace_decorator_cookbook.png" />
</Frame>
