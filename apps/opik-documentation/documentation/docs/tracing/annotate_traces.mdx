...
You don't need to manually annotate each trace to measure the performance of your LLM applications! By using Opik's [online evaluation feature](/docs/production/rules), you can define LLM as a Judge metrics that will automatically score all, or a subset, of your production traces.
...
You can find a full list of metrics in the [Heuristic Metrics](/docs/evaluation/metrics/heuristic_metrics) section.
...
You can find a full list of supported metrics in the [Metrics Overview](/docs/evaluation/metrics/overview) section.
