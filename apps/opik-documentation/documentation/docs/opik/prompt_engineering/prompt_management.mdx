...
<Tip>
  ...
  stored in the library See [Versioning prompts stored in code](/docs/opik/prompt_engineering/managing_prompts_in_code)
  for more details.
</Tip>
...
<img src="/static/img/prompt_engineering/prompt_library.png" />
</Frame>
...
[Experiments](/docs/opik/evaluation/evaluate_your_llm) allow you to evaluate the performance of your LLM application on a set of examples. When evaluating
...
<Frame>
  <img src="/static/img/evaluation/linked_prompt.png" />
</Frame>
