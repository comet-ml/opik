...
![Opik LLM as a Judge](/static/img/production/online_evaluation.gif)
...
<Frame>
  <img src="/static/img/production/online_evaluation_rule_modal.png" />
</Frame>
...
We typically recommend that you experiment with LLM as a Judge metrics during development using [Opik's evaluation framework](/docs/opik/evaluation/overview). Once you have a metric that works well for your use case, you can then use it in production.

<Frame>
  <img src="/static/img/production/online_evaluation_custom_judge.png" />
</Frame>
...
![Opik dashboard](/static/img/production/opik_monitoring_dashboard.gif)
