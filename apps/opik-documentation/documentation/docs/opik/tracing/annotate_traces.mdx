...
<Frame>
  <img src="/static/img/tracing/annotate_traces.png" />
</Frame>
...
You don't need to manually annotate each trace to measure the performance of your LLM applications! By using Opik's [online evaluation feature](/docs/opik/production/rules), you can define LLM as a Judge metrics that will automatically score all, or a subset, of your production traces.

![Online evaluation](/static/img/production/online_evaluation.gif)
...
You can find a full list of metrics in the [Heuristic Metrics](/docs/opik/evaluation/metrics/heuristic_metrics) section.
...
You can find a full list of supported metrics in the [Metrics Overview](/docs/opik/evaluation/metrics/overview) section.
