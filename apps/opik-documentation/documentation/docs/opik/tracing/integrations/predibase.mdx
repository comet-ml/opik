...
<Tip>
  ...
  guide](/docs/opik/tracing/integrations/langchain.md) or in the [Predibase cookbook](/docs/opik/cookbook/predibase.md).
</Tip>

The trace will now be available in the Opik UI for further analysis.

<Frame>
  <img src="/static/img/tracing/predibase_opik_trace.png" />
</Frame>
