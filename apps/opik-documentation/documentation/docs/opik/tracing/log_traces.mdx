...
<Tip>
  If you are just getting started with Opik, we recommend first checking out the [Quickstart](/docs/opik/quickstart)
  guide that will walk you through the process of logging your first LLM call.
</Tip>
...
<Frame>
  <img src="/static/img/tracing/introduction.png" />
</Frame>

Opik provides different ways to log your LLM calls and traces to the platform:

1. **Using one of our [integrations](/docs/opik/tracing/integrations/overview):** This is the easiest way to get started.
...
<Tip>
  ...
  guide](/docs/opik/self-host/overview) to get started. Alternatively, you can use our hosted platform by creating an
  account on [Comet](https://www.comet.com/signup?from=llm).
</Tip>
...
integrations available for [many of the most popular LLM frameworks and libraries](/docs/opik/tracing/integrations/overview).
...
method in conjunction with one of our [integrations](/docs/opik/tracing/integrations/overview) for the most seamless experience.
...
You can learn more about this feature in the [Online evaluation](/docs/opik/production/rules) guide.
...
The documentation for the Opik REST API is available [here](/docs/opik/api-reference).
