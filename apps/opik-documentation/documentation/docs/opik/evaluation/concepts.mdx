...
<Tip>
  ...
  prompts](/docs/opik/evaluation/evaluate_prompt.md) or [Evaluate your LLM
  application](/docs/opik/evaluation/evaluate_your_llm.md) guides.
</Tip>
...
<Frame>
  <img src="/static/img/evaluation/evaluation_concepts.png" />
</Frame>
...
<Tip>
  ...
  Datasets](/docs/opik/evaluation/manage_datasets.md) section.
</Tip>
...
<Frame>
  <img src="/static/img/evaluation/compare_experiment_config.png" />
</Frame>
...
1. [Overview of Opik's evaluation features](/docs/opik/evaluation/overview.mdx)
2. [Evaluate prompts](/docs/opik/evaluation/evaluate_prompt.md)
3. [Evaluate your LLM application](/docs/opik/evaluation/evaluate_your_llm.md)
