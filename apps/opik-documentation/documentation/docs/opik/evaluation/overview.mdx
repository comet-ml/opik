...
![Opik Evaluation](/static/img/evaluation/evaluation_overview.gif)
...
[Metrics Overview](/docs/opik/evaluation/metrics/overview) section.

::: tip
If you are interested in evaluating your LLM application in production, please refer to the [Online evaluation guide](/docs/opik/production/rules).
...
<Tab value="Using the Playground" title="Using the Playground">
    ...
    To use the Playground, you will need to navigate to the [Playground](/docs/opik/prompt_engineering/playground) page and:
    ...
    ![Playground](/static/img/evaluation/playground_evaluation.gif)
...
<Frame>
  <img src="/static/img/evaluation/experiment_items.png" />
</Frame>
...
1. [Evaluation concepts](/docs/opik/evaluation/concepts)
1. [Evaluate prompts](/docs/opik/evaluation/evaluate_prompt)
1. [Evaluate complex LLM applications](/docs/opik/evaluation/evaluate_your_llm)
1. [Evaluation metrics](/docs/opik/evaluation/metrics/overview)
1. [Manage datasets](/docs/opik/evaluation/manage_datasets)
