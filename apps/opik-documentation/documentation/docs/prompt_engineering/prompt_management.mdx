...
<Tip>
  ...
  stored in the library See [Versioning prompts stored in code](/docs/prompt_engineering/managing_prompts_in_code) for
  more details.
</Tip>
...
[Experiments](/docs/evaluation/evaluate_your_llm) allow you to evaluate the performance of your LLM application on a set of examples. When evaluating
