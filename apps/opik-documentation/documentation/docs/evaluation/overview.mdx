...
[Metrics Overview](/docs/evaluation/metrics/overview) section.

::: tip
If you are interested in evaluating your LLM application in production, please refer to the [Online evaluation guide](/docs/production/rules).
...
<Tab value="Using the Playground" title="Using the Playground">
    ...
    To use the Playground, you will need to navigate to the [Playground](/docs/prompt_engineering/playground) page and:
...
1. [Evaluation concepts](/docs/evaluation/concepts)
1. [Evaluate prompts](/docs/evaluation/evaluate_prompt)
1. [Evaluate complex LLM applications](/docs/evaluation/evaluate_your_llm)
1. [Evaluation metrics](/docs/evaluation/metrics/overview)
1. [Manage datasets](/docs/evaluation/manage_datasets)
