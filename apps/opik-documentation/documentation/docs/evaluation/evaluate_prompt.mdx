...
You can find a full list of all the Opik supported metrics in the [Metrics Overview](/docs/evaluation/metrics/overview) section or you can define your own metric using [Custom Metrics](/docs/evaluation/metrics/custom_metric) section.
...
To evaluate complex LLM applications like RAG applications or agents, you can use the [`evaluate`](/docs/evaluation/evaluate_your_llm) function.
