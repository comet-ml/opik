...
- Released a new [usefulness metric](/evaluation/metrics/usefulness.md)
...
- Official release of the first version of the SDK - Learn more [here](/tracing/log_traces.mdx##logging-with-the-js--ts-sdk)
