...
<Tabs>
  ...
  <TabItem value="JS / TS" title="JS / TS">
    ```bash npm install opik ```
  </TabItem>
</Tabs>
...
<Tabs>
    <TabItem value="OpenAI (Python)" title="OpenAI (Python)">
...
<TabItem value="LiteLLM (Python)" title="LiteLLM (Python)">
...
<TabItem value="Decorator (Python)" title="Decorator (Python)">
...
<TabItem value="AI Vercel SDK (JS / TS)" title="AI Vercel SDK (JS / TS)">
