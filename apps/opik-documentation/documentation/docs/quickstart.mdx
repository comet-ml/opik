...
To learn more about the `track` decorator, see the [track documentation](/tracing/log_traces#logging-traces-and-spans). Once the traces are logged, you can view them in the OPIK UI:
