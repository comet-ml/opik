...
const sidebars: SidebarsConfig = {
  guideSidebar: [
    ...
    },
    {
      ...
      label: 'Cookbooks',
      collapsed: false,
      items: ['cookbook/quickstart_notebook', 'cookbook/openai', 'cookbook/litellm', 'cookbook/langchain', 'cookbook/langgraph', 'cookbook/llama-index', 'cookbook/ollama', 'cookbook/predibase', 'cookbook/groq',
