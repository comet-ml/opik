...
1. **Backup your databases** before upgrading to version 1.9.92+
   - See [Advanced ClickHouse Backup](/v1/self-host/backup) guide
...
- [Troubleshooting](/v1/self-host/troubleshooting) - General troubleshooting guide
- [Scaling Opik](/v1/self-host/scaling) - Performance optimization guidelines
- [Kubernetes Deployment](/v1/self-host/kubernetes) - Helm chart configuration
- [Advanced ClickHouse Backup](/v1/self-host/backup) - Database backup procedures
