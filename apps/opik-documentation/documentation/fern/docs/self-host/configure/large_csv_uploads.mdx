...
- [Scaling Opik](/v1/self-host/scaling) - General scaling guidelines
- [Kubernetes Deployment](/v1/self-host/kubernetes) - Helm chart documentation
- [Troubleshooting](/v1/self-host/troubleshooting) - Common issues and solutions