...
#### Basic Setupapps/opik-documentation/documentation/fern/docs/self-host
...
- [ClickHouse Backup Command Reference](https://clickhouse.com/docs/en/sql-reference/statements/backup)
