...
<Tabs>
    <Tab value="Simple chat prompt" title="Simple chat prompt">
    ...
    <Tab value="With OpenAI" title="With OpenAI">
    ...
    <Tab value="Multi-turn conversation" title="Multi-turn conversation">
...
<Tabs>
    <Tab value="Image analysis" title="Image analysis">
    ...
    <Tab value="Video analysis" title="Video analysis">
    ...
    <Tab value="Mixed content" title="Mixed content">
...
Once a chat prompt is created in the library, you can download it in code using the [`Opik.get_chat_prompt`](https://www.comet.com/docs/opik/python-sdk-reference/Opik.html#opik.Opik.get_chat_prompt) method:
...
You can search for chat prompts specifically by using the `template_structure` filter with [`Opik.search_prompts`](https://www.comet.com/docs/opik/python-sdk-reference/Opik.html#opik.Opik.search_prompts):
...
Chat prompts support two template types for variable substitution, specified using [`PromptType`](https://www.comet.com/docs/opik/python-sdk-reference/library/PromptType.html):

<Tabs>
    <Tab value="Mustache (default)" title="Mustache (default)">
        ```python
        import opik
