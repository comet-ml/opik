---
headline: Home | Opik Documentation
og:description: Build and enhance AI applications with Opik, your essential tool for
  logging, debugging, and optimizing LLM performance effectively.
og:site_name: Opik Documentation
og:title: 'Getting Started with Opik: Optimize AI Logging'
title: Home
---
