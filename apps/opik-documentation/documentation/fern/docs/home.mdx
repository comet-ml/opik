...
scoring functions, pre-configured LLM-as-a-judge [eval metrics](/v1/evaluation/metrics/overview), and
even [automated agent optimization algorithms](/v1/agent_optimization/overview) to maximize performance. 
...
<Tip>
  ...
  self-hosting guide can be found [here](/v1/self-host/local_deployment).
</Tip>

## Core Functions

<CardGroup cols={2}>
  <Card title="Quickstart Guide" href="/v1/quickstart" icon="fa-solid fa-rocket" iconPosition="left">
    Opik integrates with your existing AI stack through your model provider or LLM framework.
  </Card>
  <Card title="LLM Observability - Log LLM Traces" href="/v1/tracing/log_traces" icon="fa-solid fa-eye" iconPosition="left">
  ...
  <Card title="Evaluation - Score Performance" href="/v1/evaluation/overview" icon="fa-solid fa-chart-line" iconPosition="left">
    Use LLM-as-a-judge and heuristic eval metrics to score your app or agent on hallucination,
    context recall, and more. 
  </Card>
  <Card title="Agent Optimization" href="/v1/agent_optimization/overview" icon="fa-solid fa-brain" iconPosition="left">
  ...
  <Card title="Self-hosting Opik" href="/v1/self-host/overview" icon="fa-solid fa-server" iconPosition="left">
