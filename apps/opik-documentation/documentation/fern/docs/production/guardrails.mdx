...
Custom guardrail allows you to define your own guardrails using a custom model, custom library or custom business logic and log the response to Opik. Here is below a basic example that filter out competitors brands:
