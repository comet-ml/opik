<Tip>
  This feature is currently available in the **self-hosted** installation of Opik.  
  Support for managed deployments is coming soon.
</Tip>
...
<Frame>
  <img src="/img/production/guardrail_example.png" />
</Frame>
