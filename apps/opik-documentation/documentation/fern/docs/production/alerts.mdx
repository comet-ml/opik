...
3. **Configure webhook settings**
   ...
   - **Routing Key** (appears when PagerDuty is selected): Enter your PagerDuty Integration Key
...
2. **In Opik**:
   ...
   - In the **Routing Key** field (appears when PagerDuty is selected), enter your PagerDuty Integration Key
   - Add triggers for the events you want to monitor
   - Click "Test connection" to verify
   - Click "Create alert"
