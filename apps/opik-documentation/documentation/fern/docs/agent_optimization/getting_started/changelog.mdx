...
### Version 2 -> 3.0.0 highlights

- First fully native multi-agent and multi-prompt optimization support end-to-end across optimizers.
- Specific reasoning models seperate from training supported across all optimizers.
...
| --- | --- | --- |
| **TBD** | `3.1.0` | Brings back tool optimization (MCP/tooling support). |
