...
og:description: Learn how HAPO (HierarchicalReflectiveOptimizer) enhances prompt refinement
...
The `HierarchicalReflectiveOptimizer` (HAPO - Hierarchical Adaptive Prompt Optimizer) uses hierarchical root cause analysis to identify and address
...
<Note>
  `HierarchicalReflectiveOptimizer` (HAPO) is ideal when you have a complex prompt that you want to refine
