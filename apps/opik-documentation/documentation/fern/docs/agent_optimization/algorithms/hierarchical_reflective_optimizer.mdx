---
description: Learn how to use the Hierarchical Reflective Optimizer to improve prompts
  through systematic root cause analysis of failure modes and targeted refinement.
headline: Hierarchical Reflective | Opik Documentation
og:description: Learn how the HierarchicalReflectiveOptimizer enhances prompt refinement
  by addressing specific failure modes through systematic analysis.
og:site_name: Opik Documentation
og:title: Hierarchical Reflective Optimization - Opik
