...
<ParamField path="model" type="str" optional={true} defaultValue="openai/gpt-5-nano">LiteLLM model name for optimizer's internal reasoning/generation calls</ParamField>
