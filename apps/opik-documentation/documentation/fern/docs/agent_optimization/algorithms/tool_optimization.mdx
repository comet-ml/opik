...
og:description: Learn to enhance your prompts using Opik's Tool Optimization feature
  for MCP tools and structured tool definitions.
...
[MetaPrompt Optimizer documentation](/v1/agent_optimization/algorithms/metaprompt_optimizer) for detailed configuration options.

</Info>

## References

- [MetaPrompt Optimizer Documentation](/v1/agent_optimization/algorithms/metaprompt_optimizer)
