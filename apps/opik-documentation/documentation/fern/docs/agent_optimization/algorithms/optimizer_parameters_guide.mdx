...
### HAPO (Hierarchical Adaptive Prompt Optimizer)

**Purpose**: HAPO (Hierarchical Adaptive Prompt Optimizer) uses hierarchical root cause analysis to systematically improve prompts by analyzing failures in batches, synthesizing findings, and addressing identified failure modes.
