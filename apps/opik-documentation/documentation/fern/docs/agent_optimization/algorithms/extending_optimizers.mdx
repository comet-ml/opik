...
- **Code Contributions**: Pull requests for new optimizers are welcome! See the
  [contribution guide](/v1/contributing/guides/agent-optimizer-sdk) for detailed instructions.
...
We encourage you to explore the existing [optimizer algorithms](/v1/agent_optimization/algorithms/overview) to see different approaches to these challenges.

## Related

- [Custom optimizer prompts](/v1/agent_optimization/advanced/prompt_customization) - Customize internal prompts
- [Custom metrics](/v1/agent_optimization/advanced/custom_metrics) - Build evaluation metrics
- [API Reference](/v1/agent_optimization/advanced/api_reference) - Full parameter documentation
