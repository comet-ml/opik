...
|------|-----------------------------|------------|--------|--------|----------|
| 1    | HAPO                         | **67.83%** | 92.70% | 28.00% | 82.80%   |
...
<Info>
  These are directional numbers. Some optimizers use more LLM/tool calls per trial than others (e.g., HAPO batches multiple analyses), so cost and runtime are not apples-to-apples even when the trial budget matches. Re-run the suite with your own datasets, models, and cost constraints before committing to a single optimizer.
</Info>
