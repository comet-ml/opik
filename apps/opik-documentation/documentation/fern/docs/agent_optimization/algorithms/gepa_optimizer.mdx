...
<Warning>
  GEPA integration is currently in <strong>Beta</strong>. APIs and defaults may evolve, and performance
  characteristics can change as we iterate. Please report issues or feedback on GitHub.
</Warning>
...
> Reference implementation: `sdks/opik_optimizer/scripts/gepa_tiny_test_example.py`
