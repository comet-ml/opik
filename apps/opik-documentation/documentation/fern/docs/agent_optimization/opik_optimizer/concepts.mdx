...
<AccordionGroup>
  <Accordion title="Optimizer">
    ...
    (e.g., [`MetaPromptOptimizer`](/v1/agent_optimization/algorithms/metaprompt_optimizer),
  ...
  <Accordion title="ChatPrompt">
    ...
    See the [API Reference](/v1/agent_optimization/advanced/api_reference#chatprompt).
  </Accordion>
  ...
  See [Configure LLM Providers](/v1/agent_optimization/optimization/configure_models) for setup instructions.
  </Accordion>
...
- Explore specific [Optimizers](/v1/agent_optimization/algorithms/overview) for algorithm details.
- Refer to the [FAQ](/v1/agent_optimization/faq) for common questions and troubleshooting.
- Refer to the [API Reference](/v1/agent_optimization/advanced/api_reference) for detailed configuration options.

<Info>
  📓 Want to see these concepts in action? Check out our [Example Projects & Cookbooks](/v1/agent_optimization/cookbooks/optimizer_introduction_cookbook)
