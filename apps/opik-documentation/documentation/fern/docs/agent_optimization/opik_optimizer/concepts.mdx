...
<AccordionGroup>
  <Accordion title="Optimizer">
    ...
    [`HRPO`](/agent_optimization/algorithms/hierarchical_reflective_optimizer))
  ...
  <Accordion title="Optimizer model">
    ...
    See [Configure LLM Providers](/agent_optimization/opik_optimizer/configure_models) for setup instructions.
  </Accordion>
</AccordionGroup>
...
<Info>
  📓 Want to see these concepts in action? Check out our [Example Projects & Cookbooks](/agent_optimization/quickstart_notebook)
