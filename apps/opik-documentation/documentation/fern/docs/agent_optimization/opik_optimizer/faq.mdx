...
<AccordionGroup>
  ...
  Once you have these, check out the [Quickstart Guide](/v1/agent_optimization/quickstart)
...
<AccordionGroup>
  ...
  - [HRPO (Hierarchical Reflective Prompt Optimizer)](/v1/agent_optimization/algorithms/hierarchical_adaptive_optimizer)
  - [GEPA Optimization](/v1/agent_optimization/algorithms/gepa_optimizer)
  - [Evolutionary Optimization](/v1/agent_optimization/algorithms/evolutionary_optimizer)
  - [Few-shot Bayesian Optimization](/v1/agent_optimization/algorithms/fewshot_bayesian_optimizer)
  - [MetaPrompt Optimization](/v1/agent_optimization/algorithms/metaprompt_optimizer)
  ...
  starting with [HRPO (Hierarchical Reflective Prompt Optimizer)](/v1/agent_optimization/algorithms/hierarchical_adaptive_optimizer)
  ...
  <Tip>
    See the [Configure LLM Providers](/v1/agent_optimization/optimization/configure_models) guide for detailed setup instructions and examples for each provider.
  </Tip>
  </Accordion>
...
For frequent setup and usage errors, head to [Known Issues](/v1/agent_optimization/known_issues). We keep the error catalog there so fixes and version notes stay in one place.
...
<AccordionGroup>
  ...
  <Accordion title="What about multimodal or agent workflows?">
    Opik supports optimizing prompts that handle images/videos, as well as agents built with LangGraph, Google ADK, or MCP toolchains. Use the [Optimize agents](/v1/agent_optimization/optimization/optimize_agents) and [Optimize multimodal](/v1/agent_optimization/optimization/optimize_multimodal) guides for modality-specific advice.
  </Accordion>
  <Accordion title="How reliable are optimizer metrics?">
    LLM-based metrics can be noisy. Always include deterministic checks when possible, and ensure your `ScoreResult.reason` is informative so reflective optimizers can identify true failure modes. See [Define metrics](/v1/agent_optimization/optimization/define_metrics) and [Custom metrics](/v1/agent_optimization/advanced/custom_metrics) for best practices.
  </Accordion>
...
- Explore [API Reference](/v1/agent_optimization/advanced/api_reference) for detailed technical documentation.
- Review the individual Optimizer pages under [Optimization Algorithms](/v1/agent_optimization/algorithms/overview).
- Check out the [Quickstart Guide](/v1/agent_optimization/quickstart).
