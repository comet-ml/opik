...
<AccordionGroup>
  ...
  - [HAPO (Hierarchical Adaptive Prompt Optimizer)](/agent_optimization/algorithms/hierarchical_reflective_optimizer)
  ...
  starting with [HAPO (Hierarchical Adaptive Prompt Optimizer)](/agent_optimization/algorithms/hierarchical_reflective_optimizer)
