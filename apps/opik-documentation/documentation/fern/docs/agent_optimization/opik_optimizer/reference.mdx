---
headline: API Reference | Opik Documentation
og:description: Explore tools to optimize LLM prompts and agents with the standardized
  API for consistent optimization across multiple algorithms.
og:site_name: Opik Documentation
og:title: API Reference - Opik Agent Optimizer SDK
...
- **HAPO (Hierarchical Adaptive Prompt Optimizer)**: Uses hierarchical root cause analysis for targeted prompt refinement
