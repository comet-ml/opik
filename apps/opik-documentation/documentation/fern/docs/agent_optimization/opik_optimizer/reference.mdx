...
<ParamField path="model" type="str" optional={true} defaultValue="gpt-4o">LiteLLM model name</ParamField>
...
<ParamField path="max_iterations" type="int" optional={true} defaultValue="5" />
