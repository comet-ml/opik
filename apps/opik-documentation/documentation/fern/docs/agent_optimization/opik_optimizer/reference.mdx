...
<ParamField path="dataset_split" type="str | None" optional={true} />
<ParamField path="scoring_health" type="dict[str, int] | None" optional={true} />
...
<ParamField path="failed" type="int" />
<ParamField path="total" type="int" />
<ParamField path="objective_metric_name" type="str | None" optional={true} />
<ParamField path="message" type="str | None" optional={true} />
