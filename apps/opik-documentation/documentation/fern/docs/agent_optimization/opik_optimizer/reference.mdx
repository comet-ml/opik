...
<ParamField path="candidate_selection_strategy" type="str" optional={true} default="pareto">Strategy for candidate selection (use "pareto", "current_best", or "epsilon_greedy"; default: "pareto")</ParamField>
