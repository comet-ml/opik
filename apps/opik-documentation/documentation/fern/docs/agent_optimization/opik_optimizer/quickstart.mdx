...
<Steps>
  ...
  <Step title="8. View results in the CLI">
    ...
    The optimization results will be displayed in your console, showing the progress and final scores.
    <Frame>
      <img src="/img/agent_optimization/sdk_cli_results.png" alt="Opik agent optimization progress in CLI" />
    </Frame>
  </Step>
  <Step title="9. View results in the Opik dashboard">
