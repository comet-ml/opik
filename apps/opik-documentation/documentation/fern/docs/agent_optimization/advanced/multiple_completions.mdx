...
- [Optimize prompts](/v1/agent_optimization/optimization/optimize_prompts) - Core optimization guide
- [Define metrics](/v1/agent_optimization/optimization/define_metrics) - Create custom metrics
- [Custom metrics](/v1/agent_optimization/advanced/custom_metrics) - Advanced metric patterns
