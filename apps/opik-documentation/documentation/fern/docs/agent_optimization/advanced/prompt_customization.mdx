...
- [API Reference](/v1/agent_optimization/opik_optimizer/reference) – Full parameter documentation
- [Custom metrics](/v1/agent_optimization/advanced/custom_metrics) – Build specialized evaluation metrics
- [Extending optimizers](/v1/agent_optimization/algorithms/extending_optimizers) – Create custom optimizer subclasses
