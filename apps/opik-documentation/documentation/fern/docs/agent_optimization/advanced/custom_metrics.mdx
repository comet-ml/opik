...
- [Evaluation concepts](/v1/evaluation/concepts) – terminology and lifecycle.
- [Metrics overview](/v1/evaluation/metrics/overview) – default heuristic metrics (ROUGE, BLEU, Hallucination, etc.).
- [LLM-as-a-judge patterns](/v1/evaluation/evaluate_agent_trajectory) – how Opik runs judge models against multi-turn traces.
...
- **Multi-metric objectives** – combine single metrics with weights when you need to balance, e.g., accuracy (0.7) + style (0.3). See [Multi-metric optimization](/v1/agent_optimization/optimization/define_metrics#compose-metrics) for templates.
...
- [Evaluation concepts](/v1/evaluation/concepts)
- [LLM judge workflows](/v1/evaluation/evaluate_agent_trajectory)
- [Metrics overview](/v1/evaluation/metrics/overview)