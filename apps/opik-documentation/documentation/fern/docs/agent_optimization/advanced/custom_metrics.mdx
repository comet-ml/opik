...
- **Multi-metric objectives** – combine single metrics with weights when you need to balance, e.g., accuracy (0.7) + style (0.3). See [Multi-metric optimization](/v1/agent_optimization/best_practices/multi_metric_optimization) for templates.
