...
- [Optimize prompts](/v1/agent_optimization/optimization/optimize_prompts)
- [Few-Shot Bayesian optimizer](/v1/agent_optimization/algorithms/fewshot_bayesian_optimizer)
- [HRPO (Hierarchical Reflective Prompt Optimizer)](/v1/agent_optimization/algorithms/hierarchical_adaptive_optimizer)
- [Parameter optimizer](/v1/agent_optimization/algorithms/parameter_optimizer)
