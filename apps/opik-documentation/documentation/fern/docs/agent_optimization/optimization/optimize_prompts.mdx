...
| --- | --- |
| General prompt copy edits | [MetaPrompt](/v1/agent_optimization/algorithms/metaprompt_optimizer) |
| Complex failure analysis | [HRPO](/v1/agent_optimization/algorithms/hierarchical_adaptive_optimizer) |
| Need diverse candidates | [Evolutionary](/v1/agent_optimization/algorithms/evolutionary_optimizer) |
| Few-shot heavy prompts | [Few-Shot Bayesian](/v1/agent_optimization/algorithms/fewshot_bayesian_optimizer) |
| Tune sampling params | [Parameter optimizer](/v1/agent_optimization/algorithms/parameter_optimizer) |
...
- [Optimize tools (MCP)](/v1/agent_optimization/optimization/optimize_tools)
...
- Use [Dashboard results](/v1/agent_optimization/optimization/dashboard_results) to visualize per-trial performance.
...
- [Define datasets](/v1/agent_optimization/optimization/define_datasets)
- [Define metrics](/v1/agent_optimization/optimization/define_metrics)
- [Chaining optimizers](/v1/agent_optimization/advanced/chaining_optimizers)
- [Avoiding overfitting](/v1/agent_optimization/optimization/define_datasets#trainvalidation-splits) – Prevent your prompt from memorizing the training data by using separate validation datasets
