...
description: "Improve prompts that invoke MCP and function tools using MetaPrompt Optimizer’s tool workflow."
---
...
Tool optimization is currently powered by the MetaPrompt Optimizer. Supply MCP metadata via `MCPExecutionConfig`.
