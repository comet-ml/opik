...
Metrics drive optimizer decisions. This guide shows how to implement single metrics, combine them, and return rich reasoning so algorithms like Hierarchical Reflective can diagnose failures.
