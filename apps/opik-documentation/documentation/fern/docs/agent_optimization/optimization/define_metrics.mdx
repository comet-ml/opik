...
| Multi-turn trajectories | [Agent trajectory evaluator](/v1/evaluation/evaluate_agent_trajectory) | Scores complete conversations, not just final outputs. |
...
When you outgrow presets, move to [Custom metrics](/v1/agent_optimization/advanced/custom_metrics) for LLM-as-a-judge flows or domain-specific scoring.
...
- Deep dive: [Multi-metric optimization guide](/v1/agent_optimization/optimization/define_metrics#compose-metrics)
- API reference: [`ScoreResult`](https://www.comet.com/docs/opik/python-sdk-reference/Objects/ScoreResult.html)
- Advanced topic: [Custom metrics](/v1/agent_optimization/advanced/custom_metrics)
