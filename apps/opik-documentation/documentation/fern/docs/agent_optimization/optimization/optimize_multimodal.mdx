...
|---|---|---|
| HAPO (Hierarchical Adaptive Prompt Optimizer) | ✓ | Ensure the `ChatPrompt.model` are vision-capable. |
...
- Use HAPO to catch recurring multimodal failures (e.g., missing chart descriptions) and highlight which dataset rows are problematic.
