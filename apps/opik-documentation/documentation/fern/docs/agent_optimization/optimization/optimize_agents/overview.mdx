...
- Explore [optimization algorithms](/v1/agent_optimization/algorithms/overview) to choose the right optimizer
- Learn about [defining datasets](/v1/agent_optimization/optimization/define_datasets) and [metrics](/v1/agent_optimization/optimization/define_metrics)
