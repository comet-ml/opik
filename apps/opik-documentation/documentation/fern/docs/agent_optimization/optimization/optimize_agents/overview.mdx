...
See `sdks/opik_optimizer/scripts/llm_frameworks/` for working agents (LangGraph, etc.). Each script doubles as both an example and a regression test during development.
