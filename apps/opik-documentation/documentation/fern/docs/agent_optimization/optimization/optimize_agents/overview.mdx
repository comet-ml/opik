...
## Existing examples
Use the sub-guides for framework-specific guidance. Each mirrors the sample code shipped under `sdks/opik_optimizer/scripts/llm_frameworks/`.

- [LangGraph](/agent_optimization/optimization/optimize_agents/langgraph) (`scripts/llm_frameworks/langgraph/`)
- [Google ADK](/agent_optimization/optimization/optimize_agents/google_adk) (`scripts/llm_frameworks/adk/`)
