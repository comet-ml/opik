...
<AccordionGroup>
  ...
  <Accordion title="Scenario 3: Enhancing a Tool-Using Agent or Complex Reasoning Task">
    ...
    **Recommended Optimizer(s):**
    - **[`MiproOptimizer`](/agent_optimization/algorithms/mipro_optimizer):** This is the best choice. It uses DSPy to optimize the entire agent structure, including the prompts that define how the agent reasons and uses tools.
