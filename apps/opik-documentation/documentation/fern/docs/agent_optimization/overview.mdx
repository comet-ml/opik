...
| Rank | Algorithm                      | Average Score | Arc dataset | GSM8K dataset | medhallu dataset | RagBench |
| ---- | ------------------------------ | ------------- | ----------- | ------------- | ---------------- | -------- |
| 1    | Few-shot Bayesian Optimization | 67.33%        | 28.09%      | 59.26%        | 91.80%           | 90.15%   |
| 2    | Mipro Optimization             | 55.91%        | 19.70%      | 39.70%        | 92.70%           | 89.28%   |
| 3    | MetaPrompt Optimization        | 52.01%        | 25.00%      | 26.93%        | 91.79%           | 64.31%   |
| *tbd*| Evolutionary Optimization      | *tbd*         | *tbd*       | *tbd*         | *tbd*            | *tbd*    |
| 4    | No optimization                | 11.99%        |  1.69%      | 24.06%        | 12.38%           |  9.81%   |
