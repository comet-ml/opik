...
- **Agent-aware** – optimize beyond system prompts, function-calling schemas, and full multi-agent systems.
...
<Cards>
  ...
  <Card title="Tool support" body="Optimize beyond system prompts: OpenAI function calling, and traditional prompt text all benefit from the same workflows." />
  <Card title="Agent integrations" body="Ready-made adapters for LangGraph, Google ADK, and custom agents, plus the ability to build your own `OptimizableAgent`." />
