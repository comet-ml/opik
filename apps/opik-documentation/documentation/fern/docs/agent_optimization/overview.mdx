...
| [GEPA Optimization](/agent_optimization/algorithms/gepa_optimizer) (Beta)                   | Wraps the external GEPA package to optimize a single system prompt for single-turn tasks using a reflection model. Requires `pip install gepa`.                                         |
...
| TBD  | GEPA Optimization                | TBD           | TBD    | TBD    | TBD      | TBD      |
