...
- Released a new [usefulness metric](/docs/evaluation/metrics/usefulness.md)
...
- Official release of the first version of the SDK - Learn more [here](/docs/tracing/log_traces.mdx#logging-with-the-js--ts-sdk)
