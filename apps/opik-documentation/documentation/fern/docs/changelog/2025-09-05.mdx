...
## 📚 Documentation 
- We've released [Opik University](/v1/opik/opik-university)! This is a new section of the docs full of video guides explaining the product.
...
- Added [documentation for models, providers, and frameworks supported for cost tracking](/v1/tracing/cost_tracking#supported-models-providers-and-integrations)
