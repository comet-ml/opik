...
👉 Access the metrics docs here: [Evaluation Metrics Overview](/v1/evaluation/metrics/overview)
...
👉 Read the full docs: [Anonymizers](/v1/production/anonymizers)
...
👉 Read more: [Alerts Guide](/v1/production/alerts)
...
- **Comet Debugger Mode** - Added Comet Debugger Mode with app version and connectivity status, helping you troubleshoot issues and understand your application's connection status. Read more about it [here](/v1/faq#using-comet-debugger-mode-uibrowser)
