...
Read the full docs here - [Alerts Guide](https://www.comet.com/docs/opik/production/alerts)
...
Links to official docs: [Evaluating traces with images](https://www.comet.com/docs/opik/production/rules#evaluating-traces-with-images) and [Using images in the Plaground](https://www.comet.com/docs/opik/prompt_engineering/playground#using-images-in-the-playground)


## Opik Optimizer Updates

**1. Support Multi-Metric Optimization** - Support for optimizing multiple metrics simultaneously with comprehensive frontend and backend changes. Read [more](https://www.comet.com/docs/opik/agent_optimization/best_practices/multi_metric_optimization)

**2. Hierarchical Reflective Optimizer** - New optimizer with self-reflective capabilities. Read more about it [here](https://www.comet.com/docs/opik/agent_optimization/algorithms/hierarchical_reflective_optimizer)
...
Read more about our [Annotation Queues](https://www.comet.com/docs/opik/evaluation/annotation_queues)
