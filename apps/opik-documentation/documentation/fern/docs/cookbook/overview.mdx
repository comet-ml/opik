...
<CardGroup cols={2}>
  ...
  <Card title="Dynamic Tracing Control" href="/docs/opik/cookbook/dynamic_tracing_cookbook">
    In this guide, we demonstrate how to use the dynamic tracing control features of the Opik platform which allows you to enable/disable tracing at runtime.
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  ...
  <Card title="OpenAI (Python)" href="/docs/opik/cookbook/openai">
    Log all OpenAI LLM calls to Opik
  </Card>
  <Card title="OpenAI (JS/TS)" href="/docs/opik/cookbook/openai-typescript">
    Log all OpenAI JavaScript/TypeScript LLM calls to Opik
  </Card>
  ...
  <Card title="Vertex AI" href="/docs/opik/cookbook/vertexai">
    Vertex AI is a managed service for deploying and scaling machine learning models
  </Card>
  <Card title="watsonx" href="/docs/opik/cookbook/watsonx">
    IBM's platform for deploying ML models
  </Card>
  <Card title="Cloudflare Workers AI" href="/docs/opik/cookbook/cloudflare-workers-ai">
    Cloudflare Workers AI provides serverless AI inference
  </Card>
  <Card title="Vercel AI SDK" href="/docs/opik/cookbook/vercel-ai-sdk">
    Vercel AI SDK provides a unified interface for AI providers
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  ...
  <Card title="Google ADK" href="/docs/opik/cookbook/google_adk_integration">
    Google ADK is a framework for building agentic applications
  </Card>
  <Card title="Gretel" href="/docs/opik/cookbook/gretel">
    Gretel is a framework for building agentic applications
  </Card>
  ...
  <Card title="LangChain (Python)" href="/docs/opik/cookbook/langchain">
    LangChain is a framework for developing applications powered by LLMs
  </Card>
  <Card title="LangChain (JS/TS)" href="/docs/opik/cookbook/langchainjs">
    LangChain JavaScript/TypeScript is a framework for developing applications powered by LLMs
  </Card>
  ...
  <Card title="OpenAI agents" href="/docs/opik/cookbook/openai-agents">
