...
> You can also run the Opik platform locally, see the [installation guide](/v1/self-host/overview?from=llm&utm_source=opik&utm_medium=colab&utm_content=eval_hall&utm_campaign=opik) for more information.
