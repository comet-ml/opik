---
subtitle: >-
  Cookbook that evalutes Opik's Hallucination Metric, showcasing both how to use
  the `evaluation` functionality in the platform as well as the quality of the
  Hallucination metric included in the SDK. It is a complex example that doesn't
  always align with how the `evaluate` function works.
slug: /cookbook/evaluate_hallucination_metric
---
