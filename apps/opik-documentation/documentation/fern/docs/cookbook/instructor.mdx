...
## Integrating with Instructor using OpenAI
...
In this notebook we will focus on the OpenAI client but this will also work for other clients like Anthropic, Bedrock, etc.
