---
subtitle: >-
  Quickstart cookbook that showcases Opik's evaluation, tracing and prompt
  management functionality.
slug: /cookbook/quickstart_notebook
---
...
_Note:_ Opik automatically deduplicates dataset items to make it easier to iterate on your dataset.
