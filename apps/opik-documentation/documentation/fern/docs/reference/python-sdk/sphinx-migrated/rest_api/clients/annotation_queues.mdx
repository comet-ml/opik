---
title: Annotation Queues Client
---
...
> API details for `opik.rest_api.annotation_queues.client.AnnotationQueuesClient` are available in the generated Core API pages.
