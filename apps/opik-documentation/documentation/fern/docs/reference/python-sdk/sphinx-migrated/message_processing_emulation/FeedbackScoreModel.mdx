...
> API details for `FeedbackScoreModel` are available in the generated Core API pages.
...
- [evaluate](/docs/opik/reference/python-sdk/sphinx-migrated/evaluation/evaluate) - For information about evaluation metrics that generate these scores
