---
title: Feedback Definitions Client
---
...
> API details for `opik.rest_api.feedback_definitions.client.FeedbackDefinitionsClient` are available in the generated Core API pages.
