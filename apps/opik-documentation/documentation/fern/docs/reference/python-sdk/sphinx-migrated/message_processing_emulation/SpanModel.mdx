...
> API details for `SpanModel` are available in the generated Core API pages.
...
- [evaluate](/docs/opik/reference/python-sdk/sphinx-migrated/evaluation/evaluate) - For information about evaluating spans with custom metrics
