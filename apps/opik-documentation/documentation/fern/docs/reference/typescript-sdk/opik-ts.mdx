...
3. **Add Custom Spans**: Learn about [manual tracing](/v1/tracing/log_traces) for custom instrumentation
4. **Set Up Evaluation**: Configure [evaluation metrics](/v1/evaluation/overview) for your LLM outputs
5. **Production Monitoring**: Set up [production monitoring](/v1/production/production_monitoring) for your application

## Further Resources

- [TypeScript SDK Overview](/reference/typescript-sdk/overview)
- [OpenAI TypeScript Integration](/v1/integrations/openai-typescript)
- [LangChain TypeScript Integration](/v1/integrations/langchainjs)
- [Vercel AI SDK Integration](/v1/integrations/vercel-ai-sdk)
