...
- **[Gemini (JS/TS)](/integrations/gemini-typescript)** - Trace and monitor your applications using the Google Generative AI Node.js SDK
...
### Option 1: Using the Opik Wizard (Recommended)

The fastest way to get started is using the [Opik Wizard](/reference/typescript-sdk/opik-wizard), an interactive CLI tool that sets up Opik automatically in your project:
...
- Set up tracing for your LLM integrations
