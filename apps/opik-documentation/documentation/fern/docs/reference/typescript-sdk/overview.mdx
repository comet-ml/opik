...
- **[Agno](/v1/integrations/agno)** - Trace and monitor your Agno AI agent applications
- **[BeeAI](/v1/integrations/beeai)** - Trace and monitor your BeeAI agent applications
- **[LangChain](/v1/integrations/langchainjs)** - Trace and monitor your LangChain applications, including chains, agents, tools, and retrievers
- **[Mastra](/v1/integrations/mastra)** - Trace and monitor your Mastra AI applications
- **[Vercel AI SDK](/v1/integrations/vercel-ai-sdk)** - Integrate Opik with Vercel AI SDK for monitoring AI-powered applications

**Model Providers:**

- **[Cloudflare Workers AI](/v1/integrations/cloudflare-workers-ai)** - Trace and monitor your Cloudflare Workers AI applications
- **[Gemini](/v1/integrations/gemini-typescript)** - Trace and monitor your applications using the Google Generative AI Node.js SDK
- **[OpenAI](/v1/integrations/openai-typescript)** - Trace and monitor your applications using the official OpenAI Node.js SDK

For a complete list of TypeScript/JavaScript integrations and other language integrations, see the [Integrations Overview](/v1/integrations/overview).
