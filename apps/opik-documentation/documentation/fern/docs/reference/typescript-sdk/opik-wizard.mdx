...
<!-- TODO: Add screenshot of wizard demo once available
<Frame>
  <img src="/img/tracing/opik_wizard_demo.png" alt="Opik Wizard Demo" />
</Frame>
-->
...
- **🔌 Integration Setup**: Configures popular LLM integrations (OpenAI, LangChain, Gemini, Vercel AI SDK)
- **⚙️ Environment Configuration**: Creates or updates `.env` files with proper Opik configuration
- **🎨 Code Formatting**: Optional Prettier integration for clean code formatting
- **🚀 Non-Interactive Mode**: Support for CI/CD pipelines with `--default` flag
