...
There's a global rate limit of `2000` request/minute per user across all REST API endpoints, with an extra burst of
`100` requests.
...
If you need to increase this limit please reach out to us on [Slack](https://chat.comet.com).
