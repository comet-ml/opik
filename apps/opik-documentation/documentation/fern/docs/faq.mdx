...
API directly - see our [API documentation](/reference/rest-api/overview) for details.
...
Opik platform, we recommend using the [Kubernetes deployment](/v1/self-host/overview) option to ensure
...
detailed integration guides in our [Integrations Overview](/v1/integrations/overview).
...
2. In the meantime, you can manually log your LLM interactions using our SDK's core logging
   functions - see our [tracing documentation](/v1/tracing/log_traces) for examples
...
[SDK Configuration guide](/v1/tracing/sdk_configuration).
