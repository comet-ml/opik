...
### ⌨️ Using Comet Debugger Mode

**Comet Debugger Mode** is a hidden diagnostic feature in the Opik UI that displays real-time
technical information to help you troubleshoot issues. This mode is particularly useful when
investigating connectivity problems, reporting bugs, or verifying your deployment version.
...
- **Network Status**: Real-time connectivity indicator showing your connection to the Opik backend
- **Opik Version**: The current version of Opik you're running (click to copy to clipboard)

This information is helpful when:

- Reporting issues to the Opik team (include the version number)
- Verifying your Opik version matches expected deployment
- Diagnosing connectivity problems between UI and backend
