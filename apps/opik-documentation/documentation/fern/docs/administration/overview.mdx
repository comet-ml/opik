...
<CardGroup cols={2}>
  <Card title="Admin Dashboard" href="/v1/administration/admin-dashboard/overview">
    Invite users, create workspaces, and manage organization settings from the admin UI.
  </Card>
  <Card title="Roles and Permissions" href="/v1/administration/roles_and_permissions">
    Learn how organization roles and workspace roles control what users can access.
  </Card>
  <Card title="Authentication" href="/v1/administration/authentication/overview">
    Set up SAML or OIDC single sign-on, or configure JWT for programmatic access.
  </Card>
  <Card title="Workspace Settings" href="/v1/administration/workspace-settings/overview">
