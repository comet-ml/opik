...
Choose [SAML](/v1/administration/authentication/saml) when:
...
- [Configure SAML](/v1/administration/authentication/saml) if you need workspace sync features.
- [Set up JWT authentication](/v1/administration/authentication/jwt) for programmatic access.
- [Manage users](/v1/administration/admin-dashboard/users) and workspace assignments.
