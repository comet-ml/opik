...
For details on available roles and permissions, see [Roles and Permissions](/v1/administration/roles_and_permissions).
...
- [Roles and Permissions](/v1/administration/roles_and_permissions) - Detailed permissions model and custom roles
- [Users](/v1/administration/admin-dashboard/users) - Organization-level user management
- [Workspaces](/v1/administration/admin-dashboard/workspaces) - Workspace concepts and hierarchy
