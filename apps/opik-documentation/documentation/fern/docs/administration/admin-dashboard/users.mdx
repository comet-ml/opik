...
Organization roles determine high-level access across the organization. See [Roles and Permissions](/v1/administration/roles_and_permissions) for details on available roles.
...
- [Roles and Permissions](/v1/administration/roles_and_permissions) - Organization and workspace roles
- [Workspace Members](/v1/administration/workspace-settings/workspace_members) - Manage users within a workspace
- [Workspaces](/v1/administration/admin-dashboard/workspaces) - Workspace management
