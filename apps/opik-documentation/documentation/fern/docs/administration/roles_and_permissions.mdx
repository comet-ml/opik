...
| **Workspace roles** | Control what users can do within a workspace | Single workspace | workspace-manage, workspace-write, workspace-read |
...
3. Optionally inherit from an existing role as a starting point.
