...
<Tip>
  ...
  prompts](/docs/evaluation/evaluate_prompt.md) or [Evaluate your LLM
  application](/docs/evaluation/evaluate_your_llm.md) guides.
</Tip>
...
<Tip>
  ...
  Datasets](/docs/evaluation/manage_datasets.md) section.
</Tip>
