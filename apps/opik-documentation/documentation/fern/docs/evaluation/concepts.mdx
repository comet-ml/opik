---
subtitle: Introduces the concepts behind Opik's evaluation framework
slug: /evaluation/concepts
---

<Tip>
  If you want to jump straight to running evaluations, you can head to the [Evaluate
  prompts](/evaluation/evaluate_prompt.md) or [Evaluate your LLM application](/evaluation/evaluate_your_llm.md) guides.
</Tip>
...
2. **Using synthetic data**: If you don't have enough data to create a diverse set of examples, you can turn to synthetic data generation tools to help you create a dataset. The [LangChain cookbook](/cookbook/langchain.md) has a great example of how to use synthetic data generation tools to create a dataset.
...
<Tip>
  You can learn more about how to manage your datasets in Opik in the [Manage Datasets](/evaluation/manage_datasets.md)
  section.
</Tip>
...
1. [Overview of Opik's evaluation features](/evaluation/overview.mdx)
2. [Evaluate prompts](/evaluation/evaluate_prompt.md)
3. [Evaluate your LLM application](/evaluation/evaluate_your_llm.md)
