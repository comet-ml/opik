...
slug: /evaluation/update_existing_experiment
---
...
<Tip>Learn more about the `evaluate` function in our [LLM evaluation guide](/docs/evaluation/evaluate_your_llm).</Tip>
