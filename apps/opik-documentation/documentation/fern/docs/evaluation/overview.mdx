...
[Metrics Overview](/v1/evaluation/metrics/overview) section.

<Tip>
  If you are interested in evaluating your LLM application in production, please
  refer to the [Online evaluation guide](/v1/production/rules). Online evaluation
...
<Note>
  **New: Multi-Value Feedback Scores** - Opik now supports collaborative
  ...
  →](/v1/tracing/annotate_traces#multi-value-feedback-scores)
</Note>
...
<Tab value="Using the Playground" title="Using the Playground">
    ...
    To use the Playground, you will need to navigate to the [Playground](/v1/prompt_engineering/playground) page and:
...
<Tip>
  Learn more about computing experiment-level metrics in the [Evaluate your LLM application](/v1/evaluation/evaluate_your_llm#computing-experiment-level-metrics) guide.
</Tip>
...
1. [Evaluation concepts](/v1/evaluation/concepts)
1. [Evaluate prompts](/v1/evaluation/evaluate_prompt)
1. [Evaluate threads](/v1/evaluation/evaluate_threads)
1. [Evaluate complex LLM applications](/v1/evaluation/evaluate_your_llm)
1. [Evaluation metrics](/v1/evaluation/metrics/overview)
1. [Manage datasets](/v1/evaluation/manage_datasets)