...
<Tip>
  **TypeScript SDK Support** Opik's evaluation function also available for
  TypeScript applications through our dedicated SDK. Check out the [TypeScript
  SDK Evaluation documentation](/reference/typescript-sdk/evaluation/overview)
