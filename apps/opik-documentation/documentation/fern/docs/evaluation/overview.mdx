...
<Tip>
  ...
  all, or a subset, of your production traces. You can also [trigger evaluation
  programmatically via the REST API](/production/rules#triggering-evaluation-rules-programmatically)
  to evaluate specific traces on demand.
</Tip>
