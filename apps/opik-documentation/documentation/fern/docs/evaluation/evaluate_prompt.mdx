...
The filter uses Opik Query Language (OQL) syntax. For more details on filter syntax and supported columns, see [Filtering datasets programmatically](/evaluation/manage_datasets#filter-syntax).
