...
1. **Opik SDK installed and configured** — See [Quickstart](/v1/quickstart) for setup
...
If your agent isn't traced yet, see [Log Traces](/v1/tracing/log_traces) to add observability first.
...
[integrations](/v1/integrations/overview) for framework-specific setup instructions.
</Tip>
...
- Learn about [Task Span Metrics](/v1/evaluation/metrics/task_span_metrics) for advanced trajectory
analysis patterns
- Optimize your agent with [Agent Optimization](/v1/agent_optimization/overview)
- Monitor agents in production with [Production Monitoring](/v1/production/production_monitoring)