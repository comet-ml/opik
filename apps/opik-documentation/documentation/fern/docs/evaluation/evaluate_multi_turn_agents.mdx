...
metrics or [create your own](/v1/evaluation/metrics/custom_conversation_metric).
...
<Tip>
You can learn more about the `evaluate_threads` function in the [evaluate_threads guide](/v1/evaluation/evaluate_threads).
</Tip>
...
- Learn more about [conversation metrics](/v1/evaluation/metrics/conversation_threads_metrics)
- Learn more about [custom conversation metrics](/v1/evaluation/metrics/custom_conversation_metric)
- Learn more about [evaluate_threads](/v1/evaluation/evaluate_threads)
- Learn more about [agent trajectory evaluation](/v1/evaluation/evaluate_agent_trajectory)