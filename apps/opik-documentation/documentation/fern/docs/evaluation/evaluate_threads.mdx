...
<Tip>
Want to create your own custom conversation metrics? Check out the [Custom Conversation Metrics guide](/v1/evaluation/metrics/custom_conversation_metric) to learn how to build specialized metrics for evaluating multi-turn dialogues.
</Tip>
...
the [conversational metrics](/v1/evaluation/metrics/conversation_threads_metrics) page.
...
[Custom Conversation Metrics guide](/v1/evaluation/metrics/custom_conversation_metric).