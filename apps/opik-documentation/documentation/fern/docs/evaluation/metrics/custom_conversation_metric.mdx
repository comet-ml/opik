...
- Learn about [built-in conversation metrics](/evaluation/metrics/overview#conversation-metrics)
- Read the [Evaluate Threads guide](/evaluation/evaluate_threads)
- Explore [custom metrics for single-turn evaluation](/evaluation/metrics/custom_metric)
