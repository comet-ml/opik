...
For more details on evaluating conversation threads, see the [Evaluate Threads guide](/v1/evaluation/evaluate_threads).

## Next Steps

- Learn about [built-in conversation metrics](/v1/evaluation/metrics/conversation_threads_metrics)
- Read the [Evaluate Threads guide](/v1/evaluation/evaluate_threads)