...
| TrajectoryAccuracy | LLM as a Judge | Evaluates the accuracy of ReAct-style agent trajectories based on reasoning and action quality | [TrajectoryAccuracy](/evaluation/metrics/trajectory_accuracy)         |
