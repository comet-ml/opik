...
| Readability Guard | Enforces Flesch–Kincaid grade bounds | [ReadabilityGuard](/evaluation/metrics/heuristic_metrics#readabilityguard) |
...
| Metric | Description | Documentation |
| --- | --- | --- |
| BLEUC | Aggregates sentence-level BLEU across assistant turns (via `BleuCMetric`) | [BLEUC](/evaluation/metrics/conversation_threads_metrics#bleucmetric) |
...
| METEORC | Aggregates METEOR scores across assistant turns (via `MeteorCMetric`) | [METEORC](/evaluation/metrics/conversation_threads_metrics#meteorcmetric) |
| ROUGEC | Aggregates ROUGE scores across assistant turns (via `RougeCMetric`) | [ROUGEC](/evaluation/metrics/conversation_threads_metrics#rougecmetric) |
