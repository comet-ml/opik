...
| ROUGE | Calculates ROUGE variants for comparing summaries or free-form text | [ROUGE](/evaluation/metrics/heuristic_metrics#rouge) |
| Sentiment | Scores sentiment using VADER (compound, pos, neu, neg) | [Sentiment](/evaluation/metrics/heuristic_metrics#sentiment) |
...
| Conversation ROUGE | Aggregates ROUGE scores across assistant turns in a thread | [Conversation ROUGE](/evaluation/metrics/conversation_threads_metrics#rougecmetric) |
| Conversation BLEU | Aggregates BLEU scores across assistant turns | [Conversation BLEU](/evaluation/metrics/conversation_threads_metrics#bleucmetric) |
| Conversation METEOR | Aggregates METEOR scores across assistant turns | [Conversation METEOR](/evaluation/metrics/conversation_threads_metrics#meteorcmetric) |
| Conversation Degeneration | Detects repetition and degeneration patterns over a conversation | [Conversation Degeneration](/evaluation/metrics/conversation_threads_metrics#conversation-degeneration-metric) |
...
| Prompt Perplexity Judge | Estimates how difficult a prompt is for models | [Prompt Diagnostics](/evaluation/metrics/prompt_diagnostics) |
...
| RevisEval Judge | Uses retrieved evidence to revise and rescore an answer | [RevisEval](/evaluation/metrics/reviseval) |
