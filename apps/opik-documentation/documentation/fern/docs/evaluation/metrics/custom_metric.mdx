...
If you want to write an LLM as a Judge metric, you can use either the [G-Eval metric](/v1/evaluation/metrics/g_eval) or create your own from scratch.
...
Also, this metric can now be used in the `evaluate` function as explained here: [Evaluating LLMs](/v1/evaluation/evaluate_your_llm).
...
<Tip>
  ...
  [Evaluate Agent Trajectory](/v1/evaluation/evaluate_agent_trajectory) guide.
</Tip>
...
[G-eval](/v1/evaluation/metrics/g_eval) allows you to specify a set of criteria for your metric and it will use a Chain of Thought prompting technique to create some evaluation steps and return a score.
You can read more about this advanced metric [here](/v1/evaluation/metrics/g_eval). 
...
Learn how to create custom conversation metrics in the [Custom Conversation Metrics guide](/v1/evaluation/metrics/custom_conversation_metric).
...
- **Evaluate your LLM application** following the [Evaluate your LLM application](/v1/evaluation/evaluate_your_llm) guide
- **Evaluate conversation threads** using the [Evaluate Threads guide](/v1/evaluation/evaluate_threads)
- **Explore built-in metrics** in the [Metrics overview](/v1/evaluation/metrics/overview)