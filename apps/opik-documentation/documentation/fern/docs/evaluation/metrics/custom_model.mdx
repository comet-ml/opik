...
3.  `async agenerate_string(self, input: str, **kwargs: Any) -> str`:
    Asynchronous version of `generate_string`.
4.  `generate_provider_response(self, **kwargs: Any) -> Any`:
...
5.  `async agenerate_provider_response(self, **kwargs: Any) -> Any`:
    Asynchronous version of `generate_provider_response`.
