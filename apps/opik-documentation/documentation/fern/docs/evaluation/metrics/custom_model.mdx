...
- **Method usage**: Both methods of the class must be defined and in order for [`generate_provider_response()`](https://www.comet.com/docs/opik/python-sdk-reference/Objects/OpikBaseModel.html#opik.evaluation.models.OpikBaseModel) to be used in the scoring process, it must be called in [`generate_string()`](https://www.comet.com/docs/opik/python-sdk-reference/Objects/OpikBaseModel.html#opik.evaluation.models.OpikBaseModel).
