...
For a complete guide on using task span metrics in LLM evaluation workflows, see the [Using task span evaluation metrics](/v1/evaluation/evaluate_your_llm#using-task-span-evaluation-metrics) section in the LLM evaluation guide.

## Related Documentation

- [Custom Metrics](/v1/evaluation/metrics/custom_metric) - Creating traditional input/output evaluation metrics
...
- [Evaluation Overview](/v1/evaluation/metrics/overview) - Understanding Opik's evaluation system