...
Steps: 1. Navigate to Evaluation > Datasets in the Opik UI. 2. Click Create new dataset. 3. In the pop-up modal:
_ Provide a name and an optional description
_ Optionally, upload a CSV file with your data 4. Click Create dataset.
