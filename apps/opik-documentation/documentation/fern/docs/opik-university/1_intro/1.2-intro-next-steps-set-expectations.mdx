...
- **Hands-On Learning**: Each video includes example notebooks accessible via links, with all content available in Opik documentation and [cookbooks](https://www.comet.com/docs/opik/cookbook/overview)
...
- **Framework Flexibility**: Choose from extensive [integrations](https://www.comet.com/docs/opik/tracing/integrations/overview) page, or use [LiteLLM](https://www.comet.com/docs/opik/tracing/integrations/litellm)/OpenRouter for unsupported models
