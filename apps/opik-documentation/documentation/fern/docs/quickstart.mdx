...
3. Documentation & Resources:
   ...
   - Reference official Opik documentation at https://www.comet.com/docs/opik/quickstart
...
After I confirm the LLM Touchpoints and entry point, find the list of supported integrations at https://www.comet.com/docs/opik/tracing/integrations/overview
...
2. Re-query the Opik docs using https://www.comet.com/docs/opik/quickstart if needed.
