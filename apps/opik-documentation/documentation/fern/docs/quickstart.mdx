...
<Tabs>
  ...
  <Tab title="OpenAI (Python)" value="openai-python-sdk">
    ...
    <Steps>
      ...
      <Step>
        Configure the Opik Python SDK, this will prompt your for your API key if you are using Opik
  ...
  <Tab title="Other" value="other">
    ...
    a full list of integrations [here](/tracing/integrations/overview).
