...
can use one of our [integrations](/integrations/overview):
...
like [LangChain](/integrations/langchain), [LangGraph](/integrations/langgraph) or [LLamaIndex](/integrations/llama_index),
...
Your LlamaIndex calls from that point forward will be logged to Opik. You can learn more about the LlamaIndex integration in the [LLamaIndex integration docs](/integrations/llama_index).
