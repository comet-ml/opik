...
opik healthcheck
```
This command will analyze your configuration and backend connectivity, providing useful insights into potential issues. The output will include two key sections:
...
Reviewing these two sections can help pinpoint the source of the problem and suggest possible resolutions.
...
The first step in integrating Opik with your codebase is to track your LLM calls. If you are using OpenAI, OpenRouter, or any LLM provider that is supported by LiteLLM, you
