...
You can learn more about configuring the Python SDK [here](/tracing/sdk_configuration.mdx).

</Tab>
<Tab value="JS / TS" title="JS / TS">

If you are using the Javascript SDK you will need to set the required required
...
<Info>
  ...
  logged data, see the [Log Traces](/tracing/log_traces.mdx) guide.
</Info>
