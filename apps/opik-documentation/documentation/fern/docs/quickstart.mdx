...
<Tabs>
  <Tab title="AI Wizard" value="ai-installation">
    ...
    [Opik extension for Cursor](/tracing/integrations/cursor):
  ...
  <Tab title="Other" value="other">
    ...
    a full list of integrations [here](/tracing/integrations/overview). For example:

    - [Dify](/tracing/integrations/dify)
    - [Agno](/tracing/integrations/agno)
    - [Ollama](/tracing/integrations/ollama)
