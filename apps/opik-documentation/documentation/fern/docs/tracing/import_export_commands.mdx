...
## `opik import WORKSPACE TYPE NAME WORKSPACE_FOLDER`
...
opik import my-workspace dataset "my-dataset" ./exported_data

# Import projects from workspace/projects directory
opik import my-workspace project "my-project" ./exported_data

# Import experiments from workspace/experiments directory (automatically recreates experiments)
opik import my-workspace experiment "my-experiment" ./exported_data

# Import prompts from workspace/prompts directory
opik import my-workspace prompt "my-prompt" ./exported_data

# Import with name pattern matching
opik import my-workspace dataset "test" ./exported_data

# Dry run to see what would be imported
opik import my-workspace project "my-project" ./exported_data --dry-run

# Import with debug output
opik import my-workspace experiment "my-experiment" ./exported_data --debug
```
...
opik import my-workspace project "old-project" ./migration_data
```
...
opik import my-workspace project "staging-project" ./exported_data
```
...
opik import my-workspace prompt "my-template" ./prompt_backup

# Import with name pattern matching
opik import my-workspace prompt "production" ./prompt_backup
```
...
# Export experiment with dataset filtering (server-side filtering for efficiency)
...
opik import my-workspace experiment "my-experiment" ./experiment_data

# Import experiments matching name pattern
opik import my-workspace experiment "evaluation" ./experiment_data
```
...
opik import my-workspace dataset "my-dataset" ./temp_data --dry-run
opik import my-workspace project "my-project" ./temp_data --dry-run
opik import my-workspace experiment "my-experiment" ./temp_data --dry-run
opik import my-workspace prompt "my-template" ./temp_data --dry-run

# 4. Actually import all data including experiments and prompts
opik import my-workspace dataset "my-dataset" ./temp_data
opik import my-workspace project "my-project" ./temp_data
opik import my-workspace experiment "my-experiment" ./temp_data
opik import my-workspace prompt "my-template" ./temp_data
