...
### Optimization:
- [Agent Optimization concepts](/v1/agent_optimization/optimization/concepts) - Core optimization concepts
- [Optimization algorithms](/v1/agent_optimization/overview) - Available optimization strategies
- [Best practices](/v1/agent_optimization/overview) - Optimization best practices

### Integration Guides:
- [SDK Configuration](/v1/tracing/sdk_configuration) - Configure Opik in your applications
- [Supported Models](/v1/tracing/cost_tracking) - Models compatible with Opik
