...
<Tip>
  If you want to jump straight to logging traces, you can head to the [Log traces](/tracing/log_traces) or [Log agent graphs](/tracing/log_agent_graphs) guides.
</Tip>
...
- [Log agent graphs](/tracing/log_agent_graphs) - Understand and visualize agent-based workflows
