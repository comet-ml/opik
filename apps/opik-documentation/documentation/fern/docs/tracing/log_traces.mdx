...
<Tabs>
    <Tab title="Python" value="python" language="python">
        ...
        For detailed API reference, see [`opik.start_as_current_trace`](/reference/python-sdk/context_manager/start_as_current_trace).
        ...
        **Parameters:**
        ...
        For detailed API reference, see [`opik.start_as_current_span`](/reference/python-sdk/context_manager/start_as_current_span).
