...
To enable debug mode for the Python SDK, set these environment variables _before_ importing `opik`:
...
If you are experiencing problems with the Python SDK, run the health check command:
