---
subtitle: Describes how to configure the Python SDK
slug: /tracing/sdk_configuration
---
...
You can find a full list of the the configuration options in the [Configuration values section](/docs/tracing/sdk_configuration#configuration-values) below.
