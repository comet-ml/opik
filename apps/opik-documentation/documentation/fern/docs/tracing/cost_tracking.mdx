...
- [Google ADK Integration](/tracing/integrations/adk)
- [AWS Bedrock Integration](/tracing/integrations/bedrock)
- [LangChain Integration](/tracing/integrations/langchain)
- [OpenAI Integration](/tracing/integrations/openai)
- [LiteLLM Integration](https://docs.litellm.ai/docs/observability/opik_integration)
- [Anthropic Integration](/tracing/integrations/anthropic)
- [CrewAI Integration](/tracing/integrations/crewai)
- [Google AI Integration](/tracing/integrations/genai)
- [Haystack Integration](/tracing/integrations/haystack)
- [LlamaIndex Integration](/tracing/integrations/llama_index)


### Supported Providers

Cost tracking is supported for the following LLM providers (as defined in [`opik.LLMProvider`](https://www.comet.com/docs/opik/python-sdk-reference/Objects/LLMProvider.html) enum):
...
- **Google AI** (`google_ai`) - Gemini models hosted in Google AI Studio (https://ai.google.dev)
