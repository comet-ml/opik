...
1. **Traces page**: Select one or more traces and click "Run evaluation" to apply trace-level rules
2. **Threads page**: Select one or more threads and click "Run evaluation" to apply thread-level rules
