...
<Tip>
  You can also trigger manual evaluation programmatically via the REST API. This is useful for integrating evaluation into custom workflows or pipelines. See [Triggering evaluation rules programmatically](/production/rules#triggering-evaluation-rules-programmatically) for details and code examples.
</Tip>
