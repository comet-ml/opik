...
2. Using the Opik REST API: You can use the [`/traces`](/reference/rest-api/api-reference/traces/get-traces-by-project) and [`/spans`](/reference/rest-api/api-reference/spans/get-spans-by-project) endpoints to export traces and spans.
...
To export traces using the Opik REST API, you can use the [`/traces`](/reference/rest-api/api-reference/traces/get-traces-by-project) endpoint and the [`/spans`](/reference/rest-api/api-reference/spans/get-spans-by-project) endpoint. These endpoints are paginated so you will need to make multiple requests to retrieve all the traces or spans you want.
