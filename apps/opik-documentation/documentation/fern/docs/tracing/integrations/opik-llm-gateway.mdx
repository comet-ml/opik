...
For production applications, we recommend using the [Kong AI Gateway](/docs/opik/integrations/kong-ai-gateway), which provides enterprise-grade features including:
