...
og:description: Connect OpenClaw to Opik with the @opik/openclaw-opik plugin.
og:site_name: Opik Documentation
og:title: OpenClaw Integration - Opik
title: Observability for OpenClaw with Opik
---

[OpenClaw](https://github.com/openclaw/openclaw) can send trace data to Opik through the community plugin package `@opik/openclaw-opik`.
...
```bash
openclaw plugins install @opik/openclaw-opik
