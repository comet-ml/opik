...
If you are using Cohere within a function tracked with the [`@track`](/v1/tracing/log_traces#using-function-decorators) decorator, you can use the tracked client as normal:
