...
For details on project name configuration, context propagation, and resolution order, see the [SDK Configuration guide](/tracing/sdk_configuration#project-name-resolution).
