...
Since TrueFoundry provides an OpenAI-compatible API for LLM deployments, we can use the [Opik OpenAI SDK wrapper](/v1/integrations/openai) to automatically log TrueFoundry calls as generations in Opik.
