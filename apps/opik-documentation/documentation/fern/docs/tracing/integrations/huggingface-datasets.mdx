...
description: Start here to integrate Opik with Hugging Face Datasets for end-to-end LLM observability, unit testing, and optimization.
---
...
{/* <Frame>
  <img src="/img/tracing/huggingface_datasets_integration.png" />
</Frame>

Screenshot should be placed at: apps/opik-documentation/documentation/fern/img/tracing/huggingface_datasets_integration.png
Documentation reference path: /img/tracing/huggingface_datasets_integration.png */}
