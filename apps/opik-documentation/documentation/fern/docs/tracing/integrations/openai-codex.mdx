...
- Codex docs also reference `otel.exporter` settings in some examples. Prefer the key path documented in the config reference for your installed Codex version.
