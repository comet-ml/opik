...
To start tracking your watsonx LLM calls, you can use our [LiteLLM integration](/v1/integrations/litellm). You'll need to have both the `opik` and `litellm` packages installed. You can install them using pip:
...
- One of the following credentials:
  ...
  - Watsonx Token: an IAM token generated from an API key, which expires and has to be refreshed. Documentation for this parameter can be found [here](https://cloud.ibm.com/docs/iam?topic=iam-iamtoken_from_apikey)
