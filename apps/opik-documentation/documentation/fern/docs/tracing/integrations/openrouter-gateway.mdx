...
- The official OpenRouter SDK (SDK-native tracing with OpenRouter tags)
...
<Tip>
If you want typed SDK-native tracing (instead of broadcast), use the OpenAI-compatible path or the dedicated [OpenRouter SDK guide](/docs/opik/integrations/openrouter/).
</Tip>
