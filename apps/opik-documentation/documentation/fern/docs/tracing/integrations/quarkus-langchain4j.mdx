...
For full endpoint/header details, see [Opik OpenTelemetry overview](/v1/tracing/opentelemetry/overview).
...
- [Opik OpenTelemetry overview](/v1/tracing/opentelemetry/overview)
