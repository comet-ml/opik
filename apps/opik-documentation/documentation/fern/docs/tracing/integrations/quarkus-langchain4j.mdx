...
For full endpoint/header details, see [Opik OpenTelemetry overview](/v1/integrations/opentelemetry).
...
- [Opik OpenTelemetry overview](/v1/integrations/opentelemetry)
