...
Since Portkey provides an OpenAI-compatible API, we can use the [Opik OpenAI SDK wrapper](/v1/integrations/openai) to automatically log Portkey calls as generations in Opik.
