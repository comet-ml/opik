---
description: Start here to integrate Opik into your AutoGen-based genai application
  for end-to-end LLM observability, unit testing, and optimization.
headline: Autogen | Opik Documentation
og:description: Build robust AI agents using Autogen's enterprise-ready framework,
  featuring built-in logging and observability for effective multi-agent systems.
