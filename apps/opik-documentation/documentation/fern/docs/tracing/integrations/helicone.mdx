...
Since Helicone provides an OpenAI-compatible proxy, we can use the [Opik OpenAI SDK wrapper](/v1/integrations/openai) to automatically log Helicone calls as generations in Opik.
