...
<CardGroup cols={3}>
  ...
  <Card title="Pipecat" href="/docs/opik/integrations/pipecat">
    Build real-time voice and multimodal conversational AI agents with comprehensive observability
  </Card>
...
<CardGroup cols={3}>
  <Card title="Gretel" href="/docs/opik/integrations/gretel">
    Generate high-quality synthetic datasets using Data Designer and Safe Synthetics for privacy-safe model training and evaluation
  </Card>
  <Card title="Hugging Face Datasets" href="/docs/opik/integrations/huggingface-datasets">
    Convert and import thousands of Hugging Face datasets into Opik format for comprehensive model evaluation
  </Card>
</CardGroup>
