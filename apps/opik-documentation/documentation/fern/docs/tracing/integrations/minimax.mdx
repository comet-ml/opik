...
[MiniMax](https://www.minimax.io/) is a leading AI company providing powerful large language models through an OpenAI-compatible API. Their latest flagship model, MiniMax-M2.7, offers enhanced reasoning and coding capabilities with a 1M token context window.
...
|-------|---------------|-------------|
| `MiniMax-M2.7` | 1M tokens | Latest flagship model with enhanced reasoning and coding |
| `MiniMax-M2.7-highspeed` | 1M tokens | High-speed version of M2.7 for low-latency scenarios |
| `MiniMax-M2.5` | 1M tokens | Previous flagship model with strong reasoning and generation capabilities |
| `MiniMax-M2.5-highspeed` | 1M tokens | Optimized for faster inference with comparable quality |
