...
To start tracking your Groq LLM calls, you can use our [LiteLLM integration](/v1/integrations/litellm). You'll need to have both the `opik` and `litellm` packages installed. You can install them using pip:
