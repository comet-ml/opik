...
Since Anannas AI provides an OpenAI-compatible API, we can use the [Opik OpenAI SDK wrapper](/v1/integrations/openai) to automatically log Anannas AI calls as generations in Opik.
