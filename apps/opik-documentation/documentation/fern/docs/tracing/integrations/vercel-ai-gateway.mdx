...
Since Vercel AI Gateway provides an OpenAI-compatible API, we can use the [Opik OpenAI SDK wrapper](/v1/integrations/openai) to automatically log Vercel AI Gateway calls as generations in Opik.
