...
[Vercel AI Gateway](https://vercel.com/docs/ai/ai-gateway) provides a unified interface to access multiple AI providers with edge-optimized performance, built-in caching, and comprehensive analytics. It's designed to work seamlessly with Vercel's edge infrastructure.
...
You'll need to set up the Vercel AI Gateway in your Vercel project. Follow the [Vercel AI Gateway setup guide](https://vercel.com/docs/ai/ai-gateway) to configure your gateway.
