...
<Tip>
  View the complete list of supported models and providers on the [Supported Models](/v1/tracing/supported_models) page.
</Tip>
...
More information on logging chat conversations can be found in the [Log conversations](/v1/tracing/log_chat_conversations) section.