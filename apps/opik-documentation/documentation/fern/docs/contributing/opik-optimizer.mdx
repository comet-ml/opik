# Contributing to the Opik Optimizer

<Warning>
  The Opik Optimizer is currently in public preview. Some features, including tests and benchmarks, might be broken or not working as expected. We're actively working on improving stability and reliability.
</Warning>

This guide will help you get started with contributing to the Opik Optimizer, our tool for optimizing prompts and improving model performance.

## Project Structure

The Opik Optimizer is located in the `sdks/opik_optimizer` directory. Here's an overview of the key components:
