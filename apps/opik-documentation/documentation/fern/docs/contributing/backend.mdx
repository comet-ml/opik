# Contributing to the Opik Backend
...
<AccordionGroup>
  <Accordion title="Health Check">
    To check the health of your locally running backend application, you can access the health check endpoint in your browser or via `curl`:
  ...
  <Accordion title="Data Migrations (DML)">
    ...
    - **Documentation**: DML migrations are documented in `CHANGELOG.md` (link to GitHub: [CHANGELOG.md](https://github.com/comet-ml/opik/blob/main/apps/opik-backend/CHANGELOG.md)) and the scripts are placed at `apps/opik-backend/data-migrations` along with detailed instructions.
