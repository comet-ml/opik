...
<CardGroup>
  ...
  <Card title="Contribute to Documentation" icon="fa-regular fa-book" href="documentation">
    Improve our guides, tutorials, and reference materials.
  </Card>
  <Card title="Contribute to Python SDK" icon="fa-brands fa-python" href="python-sdk">
    Enhance our Python library for Opik.
  </Card>
  <Card title="Contribute to TypeScript SDK" icon="fa-brands fa-js" href="typescript-sdk">
    Help improve our TypeScript library for Opik.
  </Card>
  <Card title="Contribute to Opik Optimizer" icon="fa-regular fa-gauge-high" href="opik-optimizer">
    Work on our prompt optimization tools.
  </Card>
  <Card title="Contribute to Frontend" icon="fa-regular fa-window-maximize" href="frontend">
    Develop new features and UI improvements for the Opik web application.
  </Card>
  <Card title="Contribute to Backend" icon="fa-regular fa-server" href="backend">
    Work on the core Java services powering Opik.
  </Card>
  <Card title="Participate in Bounties" icon="fa-regular fa-gem" href="bounties">
