...
<CardGroup>
  ...
  <Card title="Contribute to TypeScript SDK" icon="fa-brands fa-typescript" href="/contributing/guides/typescript-sdk">
    Help improve our TypeScript library for Opik.
  </Card>
  <Card title="Contribute to Opik Agent Optimizer" icon="fa-brands fa-gauge-high" href="/contributing/guides/agent-optimizer-sdk">
