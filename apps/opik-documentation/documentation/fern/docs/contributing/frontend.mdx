# Contributing to the Opik Frontend
...
<Steps>
  ...
  Wait for the Docker containers to build and start. To confirm that the backend is running successfully, open the following URL in your browser:
  [`http://localhost:8080/is-alive/ver`](http://localhost:8080/is-alive/ver)
