...
<AccordionGroup>
  ...
  <Accordion title="Contributing to the Python SDK Reference Documentation (Sphinx)">
    ...
    A limited migration exception exists for Fern native library-generated pages under
    `apps/opik-documentation/documentation/fern/docs/reference/python-sdk/**` while moving sections from Sphinx incrementally.
    <Steps>
      ### 1. Install Prerequisites
