# Contributing to Opik Documentation

This guide covers how to contribute to the two main parts of Opik's documentation:

1.  **This Documentation Website**: Built with [Fern](https://www.buildwithfern.com/).
2.  **Python SDK Reference Documentation**: Built with [Sphinx](https://www.sphinx-doc.org/en/master/).
...
<AccordionGroup>
  <Accordion title="Contributing to this Documentation Website (Fern)">
    ...
    <Steps>
      ...
      - `fern/docs/cookbook/`: Our collection of cookbooks and examples.
...
For any contribution, ensure you've reviewed our general [Contribution Overview](/contributing/overview) and the [Contributor License Agreement (CLA)](https://github.com/comet-ml/opik/blob/main/CLA.md). 