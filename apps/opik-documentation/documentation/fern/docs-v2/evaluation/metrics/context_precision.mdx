...
headline: Context precision
og:description: Evaluate the accuracy of LLM responses with Context Precision metric
  in Opik, identifying hallucinations and ensuring alignment with provided context.
