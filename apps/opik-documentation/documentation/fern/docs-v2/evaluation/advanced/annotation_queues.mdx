...
- **Max items in queue** caps how far automation fills the queue; once the queue holds that many items,
  nothing more is added until some are removed. A new automation starts at 100; clear the field for no limit
