---
headline: Evaluate Prompt Function
...
`evaluatePrompt` is a convenience wrapper around the [`evaluate`](/reference/typescript-sdk/evaluation/evaluate_function) function that handles:
...
- [evaluate Function](/reference/typescript-sdk/evaluation/evaluate_function) - For evaluating custom tasks
