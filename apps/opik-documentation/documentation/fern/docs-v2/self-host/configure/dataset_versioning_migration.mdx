---
headline: Dataset versioning migration
...
1. **Backup your databases** before upgrading to version 1.9.92+
   - See [Advanced ClickHouse Backup](/self-host/backup) guide
...
- [Advanced ClickHouse Backup](/self-host/backup) - Database backup procedures
