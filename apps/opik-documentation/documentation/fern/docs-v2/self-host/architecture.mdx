...
- **A Java backend service**: Java 25 + Dropwizard — REST API, authentication, business logic, and database migrations.
...
Opik's main backend uses Java 25 LTS and Dropwizard, structured as a RESTful web service offering public API
