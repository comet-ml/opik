...
To let Cursor's agent read your traces, score outputs and run evaluations, connect
the [Opik MCP server](/mcp-server). One command sets it up and installs the Opik
skills:
