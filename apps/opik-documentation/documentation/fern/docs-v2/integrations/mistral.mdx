...
First, ensure you have both `opik` and `mistralai` packages installed. This integration targets the Mistral Python SDK v1 (`from mistralai import Mistral`):

```bash
pip install opik "mistralai<2"
```
