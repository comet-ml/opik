---
headline: Administration Overview
...
- **Data anonymization** (Enterprise, preview): Mask sensitive values in trace data for users who do not have permission to see them
...
<CardGroup cols={2}>
  ...
  <Card title="Data Anonymization" href="/administration/data_anonymization">
    Mask emails, phone numbers, and other sensitive values for users without the Original data view permission.
  </Card>
</CardGroup>
