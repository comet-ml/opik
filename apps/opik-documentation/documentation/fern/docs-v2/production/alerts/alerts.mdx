...
5. **Name the alert**
   - **Name**: Opik suggests a name from your first trigger as soon as you add one — for example `Trace errors > 5 in 5 mins`, or `Trace feedback score: policy_compliance < 0.8`. Additional triggers are summarised as `+N more`.
