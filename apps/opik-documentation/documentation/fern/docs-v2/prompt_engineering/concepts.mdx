...
You can create new versions through the SDK or the Opik UI. See the [Getting started](/development/agent-configuration/getting-started) guide for details.
...
See [Guaranteed availability](/development/agent-configuration/guaranteed-availability) for more details.
