...
The skills live in
[`opik-mcp/skills`](https://github.com/comet-ml/opik-mcp/tree/main/src/opik_mcp/skills)
and reach your agent two ways:

- **With the MCP** — the agent pulls a skill on demand with `read_skill`; nothing
  to install:
...
- **Without the MCP** — install them onto disk from the
  [opik-skills front door](https://github.com/comet-ml/opik-skills):
  ...
  cp -r opik-mcp/src/opik_mcp/skills/* ~/.claude/skills/
