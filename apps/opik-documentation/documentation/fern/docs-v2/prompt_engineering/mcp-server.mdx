...
The workspace-facing skills are **transport-adaptive**: they use your Opik SDK
config by default, and this MCP server when it's connected — same skill either
way. See **[Agent Skills](/agent-skills)** for the full list and usage. A
connected agent can also pull the skills on demand (served as cacheable
resources) — nothing to install.
