...
👉 Access the metrics docs here: [Evaluation Metrics Overview](/evaluation/metrics/overview)
...
👉 Read the full docs: [Anonymizers](/production/gateway-guardrails/anonymizers)
...
👉 Read more: [Alerts Guide](/production/alerts/alerts)
...
- **Comet Debugger Mode** - Added Comet Debugger Mode with app version and connectivity status, helping you troubleshoot issues and understand your application's connection status. Read more about it [here](/faq#using-comet-debugger-mode-uibrowser)
