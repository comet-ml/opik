...
- Released a new [usefulness metric](/v1/evaluation/metrics/usefulness)
...
- Official release of the first version of the SDK - Learn more [here](/v1/tracing/log_traces#logging-with-the-js--ts-sdk)
