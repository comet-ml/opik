...
## 📚 Documentation 
- We've released [Opik University](/quickstart)! This is a new section of the docs full of video guides explaining the product.
...
- Added [documentation for models, providers, and frameworks supported for cost tracking](/tracing/advanced/cost_tracking#supported-models-providers-and-integrations)
