...
Read the full docs here - [Alerts Guide](/production/alerts/alerts)
...
Links to official docs: [Evaluating traces with images](/production/online-evaluation/rules#evaluating-traces-with-images) and [Using images in the Playground](/development/prompt-playground)


## Opik Optimizer Updates

**1. Support Multi-Metric Optimization** - Support for optimizing multiple metrics simultaneously with comprehensive frontend and backend changes. Read [more](/development/optimization-runs/optimization/define_metrics#compose-metrics)

**2. HRPO (Hierarchical Reflective Prompt Optimizer)** - New optimizer with self-reflective capabilities. Read more about it [here](/development/optimization-runs/algorithms/hierarchical_adaptive_optimizer)
...
Read more about our [Annotation Queues](/evaluation/advanced/annotation_queues)
