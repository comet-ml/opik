...
- **OTEL Integration Docs Expansion** - We've shipped a major expansion of our [OpenTelemetry integration documentation](/v1/integrations/overview), including new pages and updated guidance for multiple frameworks and providers with emphasis on TypeScript
...
- **Native MCP/Tool Optimization** - The v3.x Optimizer SDK now includes fully native [MCP and tool optimization](/v1/agent_optimization/algorithms/tool_optimization) support, including support for remote MCP and improved tool-signature handling
...
👉 [Prompt Version Tags Documentation](/v1/prompt_engineering/prompt_management#prompt-version-tags)
