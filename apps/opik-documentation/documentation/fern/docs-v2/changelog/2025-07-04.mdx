...
With support for LangGraph, Google ADK, PydanticAI, and more, this release brings a simplified API, model customization for evaluation, and standardized interfaces to streamline optimization workflows. [Learn more in the docs.](/v1/agent_optimization/overview)
...
- Added the **OpenAI agents integration cookbook** ([link](/v1/integrations/openai_agents)).
