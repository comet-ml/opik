...
- Released [online evaluation](/production/online-evaluation/rules) rules - You can now define LLM as a Judge metrics that will automatically score all, or a subset, of your production traces.
