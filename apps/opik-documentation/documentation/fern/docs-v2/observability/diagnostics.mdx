...
Manually skimming traces to catch recurring failures doesn't scale once your agent is handling
real traffic. Diagnostics runs [Ollie](/ollie) against your project's traces on a schedule,
groups repeated failures into a single issue, and gives you a root cause, a suggested fix, and the
traces to prove it — before your users report the problem.
...
<Frame>
  <img src="/img/v2/observability/diagnostics-issue-list.png" alt="Diagnostics issues list with severity, occurrences, and last seen" />
</Frame>
...
- **Users impacted**
- **Summary** — a plain-language description of the pattern Ollie detected
...
<Frame>
  <img src="/img/v2/observability/diagnostics-occurrence-and-traces.png" alt="Occurrence over time chart and affected traces sample for a diagnostics issue" />
</Frame>
...
<Frame>
  <img src="/img/v2/observability/diagnostics-resolved.png" alt="Resolved issues page" />
</Frame>
...
- [Debugging agents with Ollie and Opik Connect](/tracing/debug-agents) — Take a single
  failing trace from root cause to verified fix
- [Alerts](/production/alerts/alerts) — Get notified in Slack, PagerDuty, or a custom webhook when
  specific events happen, as a complement to Diagnostics' pattern detection
