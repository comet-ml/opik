...
function NotebookBanner() {
  ...
  if (!isCookbook) {
    ...
    return (
      <div className={clsx(styles.notebookBanner, "alert", "alert--success")}>
        <div className={styles.bannerContent}>
          <div className={styles.bannerLeft}>
            <div className={styles.bannerIcon}>
              <Tip />
            </div>
            <div className={styles.bannerText}>This is a jupyter notebook</div>
          </div>
          <div className={styles.bannerRight}>
            <button
              className={clsx(styles.notebookBannerButton)}
              type="button"
