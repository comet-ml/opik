...
<Tip>
  If you are just getting started with Opik, we recommend first checking out the [Quickstart](/quickstart.mdx) guide
...
<Tip>
  ...
  guide](/self-host/overview.md) to get started. Alternatively, you can use our hosted platform by creating an account
