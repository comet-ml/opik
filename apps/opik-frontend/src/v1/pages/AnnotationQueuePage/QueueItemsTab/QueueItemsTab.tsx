...
import TraceQueueItemsTab from "@/v1/pages/AnnotationQueuePage/QueueItemsTab/TraceQueueItemsTab";
import ThreadQueueItemsTab from "@/v1/pages/AnnotationQueuePage/QueueItemsTab/ThreadQueueItemsTab";
