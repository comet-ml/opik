...
const AgentSandboxFlowDiagram: React.FC = () => (
  <div className="flex items-center">
    {/* Opik card */}
    <div
      className="flex w-[320px] shrink-0 flex-col rounded border border-primary p-2.5"
      style={{
        background: `repeating-linear-gradient(
          135deg,
          #F3F4FD 0px, #F3F4FD 1px,
          #ffffff 1px, #ffffff 5px,
          #F3F4FD 5px, #F3F4FD 6px,
          #ffffff 6px, #ffffff 10px,
          #F3F4FD 10px, #F3F4FD 12px,
          #ffffff 12px, #ffffff 16px,
          #F3F4FD 16px, #F3F4FD 18px,
          #ffffff 18px, #ffffff 22px
        )`,
      }}
    >
      <img
      ...
      <div className="flex gap-1.5">
        <div className="flex flex-1 flex-col rounded border border-border bg-white px-2 py-1">
          <span className="mb-1 text-[10px] font-medium">Configure</span>
          <div className="flex flex-1 flex-col">
            <Tag icon={<FileTerminal className="size-2.5" />} label="Prompts" />
        ...
        <div className="flex flex-1 flex-col rounded border border-border bg-white px-2 py-1">
          ...
          <div className="flex flex-1 flex-col gap-1">
            <div className="flex-1 rounded border bg-primary-foreground px-2 py-1">
              <span className="font-mono text-[10px] leading-snug text-[#374151]">
                &ldquo;What can you
                <br />
                do?&rdquo;
              </span>
