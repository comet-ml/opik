...
import { DEFAULT_ORCA_ROUTER_CONFIGS } from "@/constants/llm";
...
// OrcaRouter is an OpenAI-compatible routing gateway and reuses the OpenRouter
// sampling-parameter surface, so it shares LLMOpenRouterConfigsType.
interface OrcaRouterModelConfigsProps {
  configs: LLMOpenRouterConfigsType;
  onChange: (configs: Partial<LLMOpenRouterConfigsType>) => void;
}

const OrcaRouterModelConfigs = ({
  configs,
  onChange,
}: OrcaRouterModelConfigsProps) => {
  return (
    <div className="flex w-72 flex-col gap-4">
      {!isUndefined(configs.temperature) && (
        <SliderInputControl
          ...
          max={1}
          step={0.01}
          defaultValue={DEFAULT_ORCA_ROUTER_CONFIGS.TEMPERATURE}
          label="Temperature"
          tooltip={
      ...
      {!isUndefined(configs.maxTokens) && (
        <SliderInputControl
          ...
          max={10000}
          step={1}
          defaultValue={DEFAULT_ORCA_ROUTER_CONFIGS.MAX_TOKENS}
          label="Max tokens"
          tooltip={
      ...
      {!isUndefined(configs.topP) && (
        <SliderInputControl
          ...
          max={1}
          step={0.01}
          defaultValue={DEFAULT_ORCA_ROUTER_CONFIGS.TOP_P}
          label="Top P"
          tooltip={
      ...
      {!isUndefined(configs.topK) && (
        <SliderInputControl
          ...
          max={100}
          step={0.01}
          defaultValue={DEFAULT_ORCA_ROUTER_CONFIGS.TOP_K}
          label="Top K"
          tooltip={
      ...
      {!isUndefined(configs.frequencyPenalty) && (
        <SliderInputControl
          ...
          max={2}
          step={0.01}
          defaultValue={DEFAULT_ORCA_ROUTER_CONFIGS.FREQUENCY_PENALTY}
      ...
      {!isUndefined(configs.presencePenalty) && (
        <SliderInputControl
          ...
          max={2}
          step={0.01}
          defaultValue={DEFAULT_ORCA_ROUTER_CONFIGS.PRESENCE_PENALTY}
      ...
      {!isUndefined(configs.repetitionPenalty) && (
        <SliderInputControl
          ...
          max={2}
          step={0.01}
          defaultValue={DEFAULT_ORCA_ROUTER_CONFIGS.REPETITION_PENALTY}
      ...
      {!isUndefined(configs.minP) && (
        <SliderInputControl
          ...
          max={1}
          step={0.01}
          defaultValue={DEFAULT_ORCA_ROUTER_CONFIGS.MIN_P}
          label="Min P"
          tooltip={
      ...
      {!isUndefined(configs.topA) && (
        <SliderInputControl
          ...
          max={1}
          step={0.01}
          defaultValue={DEFAULT_ORCA_ROUTER_CONFIGS.TOP_A}
          label="Top A"
          tooltip={
      ...
      <SliderInputControl
        value={configs.throttling ?? DEFAULT_ORCA_ROUTER_CONFIGS.THROTTLING}
        onChange={(v) => onChange({ throttling: v })}
        id="throttling"
        min={0}
        max={10}
        step={0.1}
        defaultValue={DEFAULT_ORCA_ROUTER_CONFIGS.THROTTLING}
      ...
      <SliderInputControl
        value={
          ...
          DEFAULT_ORCA_ROUTER_CONFIGS.MAX_CONCURRENT_REQUESTS
        }
        ...
        max={20}
        step={1}
        defaultValue={DEFAULT_ORCA_ROUTER_CONFIGS.MAX_CONCURRENT_REQUESTS}
...
export default OrcaRouterModelConfigs;
