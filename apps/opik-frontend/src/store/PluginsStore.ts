...
import { WorkspaceMembersTableProps } from "@/plugins/comet/WorkspaceMembersTable";
...
type PluginStore = {
  ...
  WorkspaceMembersTable: React.ComponentType<WorkspaceMembersTableProps> | null;
  init: unknown;
