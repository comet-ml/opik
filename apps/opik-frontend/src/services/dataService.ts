...
export class DataService {
  ...
  async fetchWidgetData<T = any>(
    ...
    console.log('🔴 fetchWidgetData - Called with:', { endpoint, method, queryParams, globalFilters });
    ...
    try {
      ...
      if (this.isFullUrl(trimmedEndpoint)) {
        ...
        console.log('🔴 fetchWidgetData - Using internal client for relative URL:', trimmedEndpoint);
      ...
      console.log('🔴 fetchWidgetData - Success! Data length:', Array.isArray(finalData) ? finalData.length : 'not array');
      console.log('🔴 fetchWidgetData - Final data:', finalData);
