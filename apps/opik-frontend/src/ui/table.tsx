...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "comet-fix-cell-height relative p-0 align-middle [&:has([role=checkbox])]:pr-0 [&:first-child_[data-cell-wrapper=true]]:pl-5 [&:last-child_[data-cell-wrapper=true]]:pr-5 group-hover/row:bg-row-selected group-data-[state=selected]/row:bg-row-selected",
      className,
    )}
    {...props}
  />
