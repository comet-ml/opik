...
#    - Project name
#    - Workspace name
#    - Opik URL (ending with /api/)
#
# No additional Python code is required.
# Your Dify applications will automatically send traces to Opik.

print("Dify integration is configured through the Dify UI, not through code.")
