...
IntegrationTabs.Item = ({ isActive, onClick, children }) => (
  <li
    className="comet-body-s flex h-10 w-full cursor-pointer items-center gap-2 rounded-md pl-2 pr-4 text-text-secondary hover:bg-primary-foreground data-[status=active]:bg-primary-100"
    onClick={onClick}
