    ...
    <>
      ...
      >
        <CardContent className="p-0">
          <div className="sticky top-0 z-10 flex items-center justify-between gap-2 bg-background dark:bg-accent-background shadow-[0_6px_6px_-1px_hsl(var(--background))] dark:shadow-none">
            <DropdownMenu>
