...
const CustomProviderRowActionsCell: React.FunctionComponent<
  ...
  return (
    ...
    >
      ...
      <ConfirmDialog
        ...
        description={`Are you sure you want to delete "${providerKey.keyName || "this provider"}"? This will remove access for all workspace members. This action cannot be undone.`}
...
export default CustomProviderRowActionsCell;
