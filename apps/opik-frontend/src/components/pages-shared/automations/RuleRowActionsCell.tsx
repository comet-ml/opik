  ...
  return (
    ...
    >
      ...
      <ConfirmDialog
        ...
        description={`Deleting an online evaluation rule will stop scoring for all new traces. Existing traces that have already been scores won’t be affected. This action can’t be undone. Are you sure you want to continue?
