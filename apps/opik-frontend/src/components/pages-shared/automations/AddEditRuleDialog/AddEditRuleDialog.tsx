  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description="Changing the evaluation type or scope will reset all your current configuration. Your custom prompts, messages, and settings will be lost. Do you want to continue?"
