  ...
  return (
    ...
    >
      <div className="min-w-[400px] max-w-full">
        <div className="sticky top-0 z-10 flex flex-row items-center justify-between gap-2 bg-layout-background pb-2 pl-6 pr-4 pt-4">
          ...
          <div className="sticky right-0 top-0 flex items-center gap-x-1.5 bg-layout-background pr-4 shadow-[-10px_0_10px_0_hsl(var(--layout-background))]">
            {!hasSearchOrFilter ? (
              <>
