            ...
            keyComponentProps: {
              options: [
                ...
                ...(isGuardrailsEnabled
                  ...
                  : []),
                {
                  value: SPAN_TYPE.atomic_agent,
                  label: SPAN_TYPE_LABELS_MAP[SPAN_TYPE.atomic_agent],
                },
                {
                  value: SPAN_TYPE.atomic_tool,
                  label: SPAN_TYPE_LABELS_MAP[SPAN_TYPE.atomic_tool],
                },
                {
                  value: SPAN_TYPE.atomic_chain,
                  label: SPAN_TYPE_LABELS_MAP[SPAN_TYPE.atomic_chain],
                },
              ],
