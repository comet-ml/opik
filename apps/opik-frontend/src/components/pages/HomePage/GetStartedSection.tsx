    ...
    <div>
      ...
      <div className="flex gap-x-4">
        <div
          ...
          className="flex w-full max-w-[300px] cursor-pointer items-center gap-3 rounded-md border border-action-card-border bg-action-card-background p-4 transition-shadow hover:shadow-md"
        >
