...
const PanelModal: React.FC<PanelModalProps> = ({ open, onClose, onSave, sectionId, panel }) => {
  ...
  const removeCssLibrary = (url: string) => {
    setCssIncludes(cssIncludes.filter(css => css !== url));
  };

  const removeJsLibrary = (url: string) => {
    ...
    switch (panelType) {
      ...
      case "text":
        return (
          <div className="space-y-4">
            <div>
              <label className="block mb-1 font-medium">Text Format</label>
              <select
                className="w-full border rounded px-3 py-2"
                value={textFormat}
            ...
            <div className="flex-1 min-h-0">
              ...
              <div className="border rounded overflow-hidden" style={{ height: '250px' }}>
                <Editor
                  height="250px"
                  defaultLanguage={textFormat === "html" ? "html" : "markdown"}
                  value={textContent}
      ...
      case "html":
        return (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block mb-1 font-medium">Panel Height (px)</label>
                <input
                  type="number"
                  className="w-full border rounded px-3 py-2"
                  value={htmlHeight}
              ...
              <div className="flex items-center">
                <label className="flex items-center gap-2">
                  <input
                    ...
                    className="rounded"
                  />
                  <span className="font-medium">Allow JavaScript</span>
                </label>
              </div>
            </div>
            ...
            {/* Popular Libraries Quick Add */}
            <div>
              <label className="block mb-1 font-medium">Popular Libraries</label>
              <div className="flex flex-wrap gap-2">
                <button
                  type="button"
                  onClick={() => {
                    const chartJsUrl = "https://cdn.jsdelivr.net/npm/chart.js";
                    if (!jsIncludes.includes(chartJsUrl)) {
                      setJsIncludes([...jsIncludes, chartJsUrl]);
                    }
                  }}
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (!jsIncludes.includes(d3Url)) {
                      setJsIncludes([...jsIncludes, d3Url]);
                    }
                  }}
                  className="btn btn-sm btn-secondary"
                >
                ...
                <button
                  type="button"
                  onClick={() => {
                    const plotlyUrl = "https://cdn.plot.ly/plotly-latest.min.js";
                    if (!jsIncludes.includes(plotlyUrl)) {
                      setJsIncludes([...jsIncludes, plotlyUrl]);
                    }
                  }}
                  className="btn btn-sm btn-secondary"
                >
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (!cssIncludes.includes(bootstrapCss)) {
                      setCssIncludes([...cssIncludes, bootstrapCss]);
                    }
                    if (!jsIncludes.includes(bootstrapJs)) {
                      setJsIncludes([...jsIncludes, bootstrapJs]);
                    }
                  }}
                  className="btn btn-sm btn-secondary"
                >
    ...
    <div className={`fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 ${open ? '' : 'hidden'}`}>
      <div className="bg-white rounded-lg shadow-xl w-full max-w-[95vw] max-h-[95vh] flex flex-col">
        ...
        <div ref={containerRef} className="flex flex-1 min-h-0">
          ...
          <div className="p-6 overflow-y-auto" style={{ width: `${configWidth}%` }}>
            {/* Panel Name */}
            <div className="mb-6">
          ...
          {/* Right Preview Area */}
          <div className="bg-gray-50 p-4 overflow-y-auto" style={{ width: `${100 - configWidth}%` }}>
            {renderPreview()}
          </div>
        </div>
