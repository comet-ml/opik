    ...
    <>
      ...
      <div className="flex flex-col gap-2 pb-4">
        <div className="flex items-center">
          ...
          <TooltipWrapper content="The score definition is used to define which feedback scores are returned by this rule. To return more than one score, simply add multiple scores to this section.">
