...
import { PlaygroundAnthropicConfigsType } from "@/types/providers";
import { DEFAULT_OPEN_AI_CONFIGS } from "@/constants/playground";

interface OpenAIModelSettingsProps {
  configs: PlaygroundAnthropicConfigsType;
  onChange: (configs: Partial<PlaygroundAnthropicConfigsType>) => void;
}
