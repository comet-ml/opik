  ...
  "comet-body-s inline-flex items-center justify-center rounded-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-transparent hover:bg-primary-foreground hover:text-foreground-secondary active:bg-primary-100 data-[state=on]:bg-primary-100 data-[state=on]:text-primary hover:data-[state=on]:bg-primary-100 active:data-[state=on]:bg-primary-100",
        outline:
