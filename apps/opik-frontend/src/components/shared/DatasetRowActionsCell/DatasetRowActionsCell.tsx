    ...
    return (
      ...
      >
        ...
        <ConfirmDialog
          ...
          description={`Deleting this ${entityName} will also remove all its items. Any experiments linked to it will be moved to a \u201cDeleted dataset\u201d group. This action can\u2019t be undone. Are you sure you want to continue?`}
