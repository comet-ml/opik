...
export const PROVIDER_KEYS_REST_ENDPOINT = "/v1/private/provider-keys/";
...
export const PROVIDERS_KEYS_KEY = "providers-keys";
export const AUTOMATIONS_KEY = "automations";
export const PROJECTS_KEY = "projects";
export const PROJECT_STATISTICS_KEY = "project-statistics";
export const PROJECT_BY_NAME_KEY = "project-by-name";
export const DATASETS_KEY = "datasets";
export const DATASET_ITEMS_KEY = "dataset-items";
