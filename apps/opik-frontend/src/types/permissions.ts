...
export const READ_ONLY_PERMISSIONS: PermissionsContextValue = {
  permissions: {
    canViewExperiments: true,
    ...
    canCreateAnnotationQueues: false,
    canEditAnnotationQueues: false,
    canDeleteAnnotationQueues: false,
    canDeleteTraces: false,
    canCreatePrompts: false,
    canDeletePrompts: false,
    canDeleteOptimizationRuns: false,
    canConfigureWorkspaceSettings: false,
    canUpdateAIProviders: false,
    canCreateProjects: false,
    canWriteComments: false,
    canUpdateOnlineEvaluationRules: false,
    canUpdateAlerts: false,
    canAnnotateTraceSpanThread: false,
    canTagTrace: false,
    canUsePlayground: true,
  },
  isPending: false,
