...
export enum PROVIDER_MODEL_TYPE {
  ...
  ALLENAI_MOLMO_7B_D = "allenai/molmo-7b-d",
  ...
  NOUSRESEARCH_DEEPHERMES_3_LLAMA_3_8B_PREVIEW = "nousresearch/deephermes-3-llama-3-8b-preview",
  ...
  X_AI_GROK_4_FAST_FREE = "x-ai/grok-4-fast:free",
...
export interface LLMCustomConfigsType {
  ...
  presencePenalty: number;
  seed?: number | null;
  extraBodyParameters?: Record<string, unknown> | null;
}
