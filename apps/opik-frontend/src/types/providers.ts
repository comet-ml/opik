...
export enum PROVIDER_MODEL_TYPE {
  ...
  CLAUDE_3_5_SONNET_20250107 = "claude-3-5-sonnet-20250107",
  ...
  ANTHROPIC_CLAUDE_3_5_SONNET_20250107 = "anthropic/claude-3.5-sonnet-20250107",
  ...
  DEEPSEEK_DEEPSEEK_V3_BASE = "deepseek/deepseek-v3-base",
  ...
  THEDRUMMER_VALKYRIE_49B_V1 = "thedrummer/valkyrie-49b-v1",
