...
export const getDefaultConfigByProvider = (
  ...
  if (providerType === PROVIDER_TYPE.ORCA_ROUTER) {
    return {
      maxTokens: DEFAULT_ORCA_ROUTER_CONFIGS.MAX_TOKENS,
      temperature: DEFAULT_ORCA_ROUTER_CONFIGS.TEMPERATURE,
      topP: DEFAULT_ORCA_ROUTER_CONFIGS.TOP_P,
      topK: DEFAULT_ORCA_ROUTER_CONFIGS.TOP_K,
      frequencyPenalty: DEFAULT_ORCA_ROUTER_CONFIGS.FREQUENCY_PENALTY,
      presencePenalty: DEFAULT_ORCA_ROUTER_CONFIGS.PRESENCE_PENALTY,
      repetitionPenalty: DEFAULT_ORCA_ROUTER_CONFIGS.REPETITION_PENALTY,
      minP: DEFAULT_ORCA_ROUTER_CONFIGS.MIN_P,
      topA: DEFAULT_ORCA_ROUTER_CONFIGS.TOP_A,
      throttling: DEFAULT_ORCA_ROUTER_CONFIGS.THROTTLING,
      maxConcurrentRequests:
