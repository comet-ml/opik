...
public record Trace(
        ...
        @JsonView({
                Trace.View.Public.class}) @Schema(accessMode = Schema.AccessMode.READ_ONLY, description = "Number of attachments associated with this trace") int attachmentCount){
