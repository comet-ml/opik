...
public record Prompt(
        ...
        @JsonView({
                Prompt.View.Write.class}) @Schema(description = "For project scope, specify either project_id or project_name. If project_name is provided and the project does not exist, it will be created. Ignored when project_id is provided. If neither is provided, the prompt is created at workspace level.") @Nullable String projectName,
