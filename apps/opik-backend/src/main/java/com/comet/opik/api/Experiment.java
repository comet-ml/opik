...
public record Experiment(
        ...
        @JsonView({
                Experiment.View.Public.class}) @Schema(accessMode = Schema.AccessMode.READ_ONLY) PercentageValues totalEstimatedCostMetrics,
        @JsonView({
                Experiment.View.Public.class}) @Schema(accessMode = Schema.AccessMode.READ_ONLY) List<FeedbackScoreMetric> feedbackScoreMetrics,
        @JsonView({
