...
public record Dashboard(
    ...
    public record DashboardPage(
            @JsonView( {
                    View.Public.class}) @NotNull List<Dashboard> content,
            @JsonView({View.Public.class}) @NotNull Integer page,
            @JsonView({View.Public.class}) @NotNull Integer size,
            @JsonView({View.Public.class}) @NotNull Long total){
    }
}