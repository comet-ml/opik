...
public class AnnotationQueueConditionEvaluator {
     ...
     * its conditions do.
     */
    public boolean matches(@NonNull Conditions conditions,
    ...
    private boolean matchesGroup(ConditionGroup group, Map<String, BigDecimal> scores) {
     ...
     */
    private boolean matchesCondition(ScoreCondition condition,
