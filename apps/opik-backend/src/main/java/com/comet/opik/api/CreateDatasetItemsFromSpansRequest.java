...
public record CreateDatasetItemsFromSpansRequest(
        ...
        @Schema(description = "Optional mapping of dataset item field name to a path into the span, e.g. 'input.input_text'. Takes precedence over the fields produced by enrichment_options.") @SupportedFieldMappingPaths @Size(max = 100, message = "field_mappings cannot exceed 100 entries") Map<String, String> fieldMappings) {
}
