...
public record ExperimentItem(
        ...
        @JsonView({
                ExperimentItem.View.Public.class}) @Schema(accessMode = Schema.AccessMode.READ_ONLY, description = "Execution policy for this experiment item. Captured from dataset item version at item creation time.") ExecutionPolicy executionPolicy){
