...
public class MapObjectArgumentFactory extends AbstractArgumentFactory<Map<String, Object>>
        implements
            ColumnMapper<Map<String, Object>> {

    public static final TypeReference<Map<String, Object>> TYPE_REFERENCE = new TypeReference<>() {
    };

    public MapObjectArgumentFactory() {
        super(Types.VARCHAR);
    }
    ...
    @Override
    public Map<String, Object> map(ResultSet r, String columnLabel, StatementContext ctx) throws SQLException {
