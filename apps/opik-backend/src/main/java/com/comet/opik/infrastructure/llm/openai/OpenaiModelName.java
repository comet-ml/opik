...
public enum OpenaiModelName implements ModelDefinition {
    ...
    GPT_O1("o1", true),
    GPT_O1_2024_12_17("o1-2024-12-17", true),
    GPT_O1_MINI("o1-mini", true),
    GPT_O1_MINI_2024_09_12("o1-mini-2024-09-12", true),
    GPT_O1_PREVIEW("o1-preview", true),
    GPT_O1_PREVIEW_2024_09_12("o1-preview-2024-09-12", true),
    GPT_O3_MINI("o3-mini", true);
