...
public class DashboardResource {
    ...
    public Response getDashboardById(@PathParam("id") UUID id) {
        var dashboard = service.findById(id)
    ...
    public Response getDashboards(
        ...
        var dashboardPage = service.find(page, size, search, orderBy, sortOrder)
                .contextWrite(ctx -> setRequestContext(ctx, requestContext))
                .block();
    ...
    public Response createDashboard(
        ...
        var dashboard = service.create(request)
                .contextWrite(ctx -> setRequestContext(ctx, requestContext))
                .block();
    ...
    public Response updateDashboard(
        ...
        var dashboard = service.update(id, update)
                .contextWrite(ctx -> setRequestContext(ctx, requestContext))
                .block();
