...
public record AgentBlueprint(
        ...
        @JsonView({AgentConfig.View.Public.class, AgentConfig.View.History.class}) List<String> envs,
        ...
        @JsonView({AgentConfig.View.Public.class,
                AgentConfig.View.Write.class}) @Valid @NotEmpty List<AgentConfigValue> values){
