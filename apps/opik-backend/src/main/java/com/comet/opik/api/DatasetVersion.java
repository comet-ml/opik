...
public record DatasetVersion(
        ...
        @JsonView(DatasetVersion.View.Public.class) @Schema(accessMode = Schema.AccessMode.READ_ONLY, description = "Sequential version number formatted as 'v1', 'v2', etc.") String versionSequence,
