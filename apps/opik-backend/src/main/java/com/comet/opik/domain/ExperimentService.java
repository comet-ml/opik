...
public class ExperimentService {
    ...
    public Mono<Experiment.GroupedExperimentPage> findGrouped(
            ...
            List<? extends com.comet.opik.api.filter.Filter> experimentFilters, UUID promptId) {
        log.info("Finding grouped experiments: page={}, size={}, sortingFields={}, promptId={}",
                page, size, sortingFields, promptId);
