...
public record Dataset(
        ...
        @JsonView({Dataset.View.Public.class, Dataset.View.Write.class}) @Nullable UUID projectId,
        @JsonView({
                Dataset.View.Write.class}) @Schema(description = "For project scope, specify either project_id or project_name. If project_name is provided and the project does not exist, it will be created. If neither is provided, the dataset is created at workspace level.") @Nullable String projectName,
