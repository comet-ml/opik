...
public record DatasetItemBatch(
        ...
        @JsonView({DatasetItem.View.Write.class}) @Schema(description = "Whether to include trace metadata (tags, comments, feedback scores, etc.) in dataset items", defaultValue = "false") Boolean includeTraceMetadata)
        implements
            RateEventContainer{
