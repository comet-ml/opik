...
public interface DatasetEvaluatorDAO {
    ...
    @SqlBatch("INSERT INTO dataset_evaluators(id, workspace_id, dataset_id, name, type, config, created_by, last_updated_by) "
            + "VALUES (:bean.id, :workspaceId, :bean.datasetId, :bean.name, :bean.type, :bean.config, :bean.createdBy, :bean.lastUpdatedBy)")
