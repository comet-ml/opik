...
CREATE TABLE IF NOT EXISTS ${ANALYTICS_DB_DATABASE_NAME}.trace_threads ON CLUSTER '${ANALYTICS_DB_CLUSTER_NAME}' (
    id                  FixedString(36),
    thread_id           String,
...
--rollback DROP TABLE IF EXISTS ${ANALYTICS_DB_DATABASE_NAME}.trace_threads ON CLUSTER '${ANALYTICS_DB_CLUSTER_NAME}';
