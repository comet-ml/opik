...
--changeset thiagohora:000081_materialize_spans_skip_indexes
--comment: Materialize skip indexes on spans (~19.5TB/1.42B rows). Apply after 000080 mutations complete: SELECT * FROM system.mutations WHERE is_done = 0 AND table = 'spans'.
