...
--changeset thiagohora:000082_materialize_authored_feedback_scores_skip_indexes
--comment: Materialize skip indexes on authored_feedback_scores (~251M rows). Apply after 000081 mutations complete: SELECT * FROM system.mutations WHERE is_done = 0 AND table = 'authored_feedback_scores'.
