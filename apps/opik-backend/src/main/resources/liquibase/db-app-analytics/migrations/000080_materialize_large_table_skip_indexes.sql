...
--changeset thiagohora:000080_materialize_traces_skip_indexes
--comment: Materialize skip indexes on traces (~5.77TB/288M rows). Apply after 000079 mutations complete: SELECT * FROM system.mutations WHERE is_done = 0 AND table = 'traces'.
