...
ALTER TABLE agent_blueprints ADD COLUMN `values` JSON NULL;
...
--rollback     INDEX idx_agent_config_values_prompt_lookup (workspace_id, type, value(255), valid_to_blueprint_id)
--rollback );
