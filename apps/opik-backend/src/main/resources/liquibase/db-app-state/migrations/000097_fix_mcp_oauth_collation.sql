...
--changeset yaroslavb:000097_fix_mcp_oauth_collation
...
--comment: collated table fails with "illegal mix of collations" — which the connected-clients query in 000098
