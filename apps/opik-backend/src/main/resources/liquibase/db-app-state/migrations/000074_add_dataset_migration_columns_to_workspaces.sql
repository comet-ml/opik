...
--comment: Add dataset-project migration skip tracking columns to workspaces table, mirroring the experiment_project_migration_skipped_at/skip_reason pattern added in 000073.

ALTER TABLE workspaces
    ADD COLUMN dataset_project_migration_skipped_at TIMESTAMP(6) NULL AFTER experiment_project_migration_skip_reason,
    ADD COLUMN dataset_project_migration_skip_reason VARCHAR(100) NULL AFTER dataset_project_migration_skipped_at;
