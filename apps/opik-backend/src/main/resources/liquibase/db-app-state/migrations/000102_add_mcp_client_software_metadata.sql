...
--changeset yaroslavb:000102_add_mcp_client_software_metadata
...
--rollback ALTER TABLE mcp_client_connections DROP COLUMN software_id, DROP COLUMN software_version, DROP COLUMN client_uri;
