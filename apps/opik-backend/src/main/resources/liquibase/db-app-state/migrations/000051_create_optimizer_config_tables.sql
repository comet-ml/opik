...
CREATE TABLE optimizer_config (
    ...
    CONSTRAINT optimizer_config_workspace_id_uk UNIQUE (workspace_id)
);
...
CREATE TABLE optimizer_blueprint (
    ...
    CONSTRAINT optimizer_blueprint_workspace_config_id_uk UNIQUE (workspace_id, config_id, id)
);
...
CREATE TABLE optimizer_config_envs (
    ...
    CONSTRAINT optimizer_config_envs_workspace_config_env_uk UNIQUE (workspace_id, config_id, env_name)
);
