...
public class FilterTestUtils {
    ...
    public static String getValidValue(Field field) {
        return switch (field.getType()) {
            case STRING, STRING_EXACT, STRING_EXACT_LIST, LIST, DICTIONARY, DICTIONARY_STATE_DB, MAP, ENUM, ENUM_LEGACY,
    ...
    public static String getKey(Field field) {
        return switch (field.getType()) {
            case STRING, STRING_EXACT, STRING_EXACT_LIST, NUMBER, DURATION, DATE_TIME, LIST, ENUM, ENUM_LEGACY,
    ...
    public static String getInvalidValue(Field field) {
        return switch (field.getType()) {
            case STRING, STRING_EXACT, STRING_EXACT_LIST, DICTIONARY, DICTIONARY_STATE_DB, MAP, CUSTOM, LIST, ENUM,
