...
/**
 * Covers {@link TraceDAOImpl#weeklyPartitionsOf}, which derives the weekly partition values a delete batch resolves
 ...
 */
class TraceDAOPartitionPruningTest {

    @Test
    @DisplayName("matches the partition ClickHouse computed — ordinary id")
    void ordinaryId() {
        // id_at 2026-08-19 (a Wednesday) -> Monday 2026-08-17
        assertThat(TraceDAOImpl.weeklyPartitionsOf(List.of(UUID.fromString("01a01a75-76de-785e-ae84-8870ed5e6db3"))))
    ...
    void farFutureId() {
        ...
        assertThat(TraceDAOImpl.weeklyPartitionsOf(List.of(UUID.fromString("0699eb8a-59dd-7215-8000-03b8d2a8d5e2"))))
    ...
    void oldId() {
        ...
        assertThat(TraceDAOImpl.weeklyPartitionsOf(List.of(UUID.fromString("00bfd451-fa93-7c10-9923-88a219a974c8"))))
    ...
    void scatteredBatch() {
        ...
        assertThat(TraceDAOImpl.weeklyPartitionsOf(List.of(
    ...
    void singleNonV7() {
        assertThat(TraceDAOImpl.weeklyPartitionsOf(List.of(UUID.fromString("9f527bac-527a-4f92-8875-0fa8af8e4f22"))))
                .isEmpty();
    }
    ...
    void emptyBatch() {
        assertThat(TraceDAOImpl.weeklyPartitionsOf(List.of())).isEmpty();
    }
}
