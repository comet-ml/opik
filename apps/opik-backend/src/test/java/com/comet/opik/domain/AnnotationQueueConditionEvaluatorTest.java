...
class AnnotationQueueConditionEvaluatorTest {
    ...
    private static ScoreCondition condition(String score, ScoreConditionOperator operator, double value) {
    ...
    class SingleCondition {
        ...
        void greaterThan() {
            var conditions = groups(List.of(condition("hallucination", ScoreConditionOperator.GREATER_THAN, 0.7)));
        ...
        void boundaryIsExclusive() {
            var greater = groups(List.of(condition("hallucination", ScoreConditionOperator.GREATER_THAN, 0.7)));
            var less = groups(List.of(condition("hallucination", ScoreConditionOperator.LESS_THAN, 0.7)));
    ...
    class MissingScores {
        ...
        void conjunctionCompletesWhenLastScoreLands() {
            var conditions = groups(List.of(
                    condition("hallucination", ScoreConditionOperator.GREATER_THAN, 0.7),
                    condition("answer_relevance", ScoreConditionOperator.LESS_THAN, 0.3)));
    ...
    class Groups {
        ...
        void acrossGroupsIsOr() {
            var conditions = groups(
                    List.of(condition("hallucination", ScoreConditionOperator.GREATER_THAN, 0.7)),
                    List.of(condition("moderation", ScoreConditionOperator.GREATER_THAN, 0.9)));
        ...
        void missingScoreInOneGroupDoesNotVetoAnother() {
            var conditions = groups(
                    List.of(condition("never_scored", ScoreConditionOperator.GREATER_THAN, 0.5)),
                    List.of(condition("moderation", ScoreConditionOperator.GREATER_THAN, 0.9)));
