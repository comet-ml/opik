...
class ModelNameMatcherTest {
    ...
    void findInMapReturnsEmptyForNullModelName() {
        ...
        assertThat(ModelNameMatcher.findInMap(map, null)).isEmpty();
    }
    ...
    void findInMapReturnsEmptyForBlankModelName() {
        ...
        assertThat(ModelNameMatcher.findInMap(map, "")).isEmpty();
        assertThat(ModelNameMatcher.findInMap(map, "   ")).isEmpty();
    }

    @Test
    void findInMapReturnsEmptyForEmptyMap() {
        assertThat(ModelNameMatcher.findInMap(Map.of(), "gpt-4")).isEmpty();
    }
    ...
    void findInMapFindsExactMatch() {
        ...
        assertThat(ModelNameMatcher.findInMap(map, "gpt-4")).contains("value1");
        assertThat(ModelNameMatcher.findInMap(map, "gpt-3.5-turbo")).contains("value2");
    }
    ...
    void findInMapIsCaseInsensitive() {
        ...
        assertThat(ModelNameMatcher.findInMap(map, "GPT-4")).contains("value");
        assertThat(ModelNameMatcher.findInMap(map, "Gpt-4")).contains("value");
        assertThat(ModelNameMatcher.findInMap(map, "GPT-4")).contains("value");
    }
    ...
    void findInMapMatchesWithoutProviderPrefix() {
        ...
        assertThat(ModelNameMatcher.findInMap(map, "openai/gpt-4")).contains("value");
        assertThat(ModelNameMatcher.findInMap(map, "gpt-4")).contains("value");
    }
    ...
    void findInMapMatchesSuffixWithDifferentPrefix() {
        ...
        assertThat(ModelNameMatcher.findInMap(map, "deepinfra/qwen/qwen2.5-vl-32b-instruct")).contains("value");
        assertThat(ModelNameMatcher.findInMap(map, "qwen/qwen2.5-vl-32b-instruct")).contains("value");
        assertThat(ModelNameMatcher.findInMap(map, "qwen2.5-vl-32b-instruct")).contains("value");
        assertThat(ModelNameMatcher.findInMap(map, "openrouter/qwen/qwen2.5-vl-32b-instruct")).contains("value");
    }
    ...
    void findInMapHandlesColonSuffixes() {
        ...
        assertThat(ModelNameMatcher.findInMap(map, "model:free")).contains("value");
        assertThat(ModelNameMatcher.findInMap(map, "openrouter/model:free")).contains("value");
    }
    ...
    void findInMapReturnsEmptyForNoMatch() {
        ...
        assertThat(ModelNameMatcher.findInMap(map, "unknown-model")).isEmpty();
    }
    ...
    void findInMapPrioritizesExactMatchOverSuffixMatch() {
        ...
        assertThat(ModelNameMatcher.findInMap(map, "qwen/model")).contains("exact-value");
    }
    ...
    void findInMapHandlesComplexScenario() {
        ...
        assertThat(ModelNameMatcher.findInMap(map, "gpt-4")).contains("openai-value");
        assertThat(ModelNameMatcher.findInMap(map, "CLAUDE-3")).contains("anthropic-value");
        assertThat(ModelNameMatcher.findInMap(map, "qwen/qwen2.5-vl-32b-instruct")).contains("deepinfra-value");
        assertThat(ModelNameMatcher.findInMap(map, "qwen2.5-vl-32b-instruct")).contains("deepinfra-value");
    }
    ...
    void findInMapReturnsFirstMatchInSuffixMatching() {
        ...
        var result = ModelNameMatcher.findInMap(map, "model");
    ...
    void findInMapHandlesCaseInsensitiveSuffixMatching() {
        ...
        assertThat(ModelNameMatcher.findInMap(map, "DeepInfra/Qwen/Model")).contains("value");
        assertThat(ModelNameMatcher.findInMap(map, "QWEN/MODEL")).contains("value");
        assertThat(ModelNameMatcher.findInMap(map, "Model")).contains("value");
    }
    ...
    void findInMapMatchesCompleteSegments() {
        ...
        assertThat(ModelNameMatcher.findInMap(map, "gpt-4-turbo")).contains("value");
        assertThat(ModelNameMatcher.findInMap(map, "openai/gpt-4-turbo")).contains("value");

        // "turbo" alone won't match because "gpt-4-turbo" is a single segment
        // (no slash separating "gpt-4" from "turbo")
        assertThat(ModelNameMatcher.findInMap(map, "turbo")).isEmpty();
    }
}
