...
class TestResolveProjectName:
    def test_explicit_project_name_returned(self):
        result = helpers.resolve_project_name(
            manually_passed_value="My Project",
            config_project_name=OPIK_PROJECT_DEFAULT_NAME,
        )
    ...
    def test_explicit_default_project_name_no_warning(self):
        with patch("opik.api_objects.helpers.opik_logging.log_once_at_level") as mock_log:
            result = helpers.resolve_project_name(
                manually_passed_value=OPIK_PROJECT_DEFAULT_NAME,
                config_project_name=OPIK_PROJECT_DEFAULT_NAME,
            )
    ...
    def test_context_project_returned(self):
        result = helpers.resolve_project_name(
            ...
            config_project_name=OPIK_PROJECT_DEFAULT_NAME,
            context_project_name="Context Project",
        )
    ...
    def test_non_default_config_project_no_warning(self):
        with patch("opik.api_objects.helpers.opik_logging.log_once_at_level") as mock_log:
            result = helpers.resolve_project_name(
                manually_passed_value=None,
                config_project_name="Custom Project",
            )
