...
#     assert updated_rest_items[0]["input"] == {"key": "updated_value"}, "Input should be updated"
#     assert updated_rest_items[0]["expected_output"] == {
#         "key": "updated_output"
#     }, "Expected output should be updated"
#     assert updated_rest_items[0]["metadata"] == {
