...
class TestCreateBlueprint:
    def test_create_blueprint__happy_path__calls_backend_and_returns_id(
        self, config_client, mock_rest_client
    ):
        result = config_client.create_blueprint(
            fields_with_values={
    ...
    def test_create_blueprint__with_project_id__passes_project_id_to_backend(
        self, config_client, mock_rest_client
    ):
        config_client.create_blueprint(
            fields_with_values={"temp": (float, 0.5)},
...
class TestTryGetBlueprint:
    ...
    def test_get_blueprint__found__returns_raw_blueprint(
        self, config_client, mock_rest_client
    ):
