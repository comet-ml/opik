...
class TestSimulatedUser:
    ...
    def test_generate_response_with_llm(self, mock_get_model):
        ...
        assert "You are a simulated user with the following persona: You are a helpful assistant" in call_args
    ...
    def test_generate_response_with_long_history(self, mock_get_model):
        ...
        assert "You are a simulated user with the following persona: Test persona" in call_args
