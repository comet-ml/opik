...
def test_split_list_into_batches__by_memory_and_by_size():
    ...
    batches = batch_splitter.split_list_into_batches(items, max_length=2, max_payload_size_MB=3.5)
...
def test_split_list_into_batches__empty_list():
    items = []
    batches = batch_splitter.split_list_into_batches(items, max_length=3, max_payload_size_MB=3.5)
...
def test_split_list_into_batches__multiple_large_objects():
    ...
    batches = batch_splitter.split_list_into_batches(items, max_length=2, max_payload_size_MB=0.5)
