...
from opik.evaluation.metrics.conversation.conversational_coherence import schema
from opik.evaluation.metrics.conversation.conversational_coherence.metric import (
...
def test_score__with_all_relevant_responses(mock_model, simple_conversation):
    ...
    mock_model.generate_string.side_effect = side_effect
...
def test_score_with_mixed_relevance(mock_model, irrelevant_conversation):
