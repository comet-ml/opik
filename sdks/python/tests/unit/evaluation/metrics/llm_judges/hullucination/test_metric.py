...
def test_hallucination_score_out_of_range():
    ...
    invalid_model_output = '{"score": 1.2, "reason": "Score exceeds valid range."}'  # Score > 1.0

    with pytest.raises(MetricComputationError, match=logging_messages.HALLUCINATION_DETECTION_FAILED):
