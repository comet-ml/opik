...
def make_http_request(base_url, message, workspace_name, comet_api_key):
    try:
        ...
        response = requests.request(message['method'], url, json=message['payload'], headers=headers)
    ...
    items = [
        {
            ...
            "trace_id": uuid7str(),
            "input": {"question": "What is the total revenue generated by each country?"},
            "output": {"output": "SELECT c.\"Country\", SUM(il.\"UnitPrice\" * il.\"Quantity\") AS \"TotalRevenue\"\nFROM \"Invoice\" i\nJOIN \"Customer\" c ON i.\"CustomerId\" = c.\"CustomerId\"\nJOIN \"InvoiceLine\" il ON i.\"InvoiceId\" = il.\"InvoiceId\"\nGROUP BY c.\"Country\"\nORDER BY \"TotalRevenue\" DESC;\nLIMIT 5;"},
            "score": 0,
        ...
        },
        {
            ...
            "dataset_item_id": uuid7str(),
            "trace_id": uuid7str(),
            "input": {"question": "Which employee has the highest average number of sales per month?"},
            "output": {"output": "SELECT e.FirstName, e.LastName, AVG(i.Total) as AvgSalesPerMonth\nFROM Employee e\nJOIN Customer c ON e.EmployeeId = c.SupportRepId\nJOIN Invoice i ON c.CustomerId = i.CustomerId\nGROUP BY e.EmployeeId\nORDER BY AvgSalesPerMonth DESC\nLIMIT 1;"},
            "score": 1,
        ...
        },
        {
            ...
            "dataset_item_id": uuid7str(),
            "trace_id": uuid7str(),
            "input": {"question": "What is the average revenue generated per customer in each genre?"},
            "output": {"output": "SELECT g.\"Name\" AS \"Genre\", AVG(il.\"UnitPrice\" * il.\"Quantity\") AS \"Average Revenue per Customer\"\nFROM \"Genre\" g\nJOIN \"Track\" t ON g.\"GenreId\" = t.\"GenreId\"\nJOIN \"InvoiceLine\" il ON t.\"TrackId\" = il.\"TrackId\"\nGROUP BY g.\"Name\"\nORDER BY \"Average Revenue per Customer\" DESC\nLIMIT 5;"},
            "score": 1,
            "reason": "Query ran successfully"
        },
        {
            ...
            "dataset_item_id": uuid7str(),
            "trace_id": uuid7str(),
            "input": {"question": "How many unique customers made at least one purchase in each year?"},
            "output": {"output": "SELECT COUNT(DISTINCT c.CustomerId) AS UniqueCustomers\nFROM Customer c\nWHERE c.CustomerId IN (\n    SELECT i.CustomerId\n    FROM Invoice i\n    GROUP BY i.CustomerId\n    HAVING COUNT(DISTINCT strftime('%Y', i.InvoiceDate)) = (SELECT COUNT(DISTINCT strftime('%Y', InvoiceDate)) FROM Invoice)\n)"},
            "score": 1,
            "reason": "Query ran successfully",
        },
        {
            ...
            "dataset_item_id": uuid7str(),
            "trace_id": uuid7str(),
            "input": {"question": "Which customers have made purchases in every genre?"},
            "output": {"output": "SELECT c.\"CustomerId\", c.\"FirstName\", c.\"LastName\"\nFROM \"Customer\" c\nWHERE c.\"CustomerId\" IN (\n    SELECT i.\"CustomerId\"\n    FROM \"Invoice\" i\n    JOIN \"InvoiceLine\" il ON i.\"InvoiceId\" = il.\"InvoiceId\"\n    JOIN \"Track\" t ON il.\"TrackId\" = t.\"TrackId\"\n    JOIN \"Genre\" g ON t.\"GenreId\" = g.\"GenreId\"\n    GROUP BY i.\"CustomerId\"\n    HAVING COUNT(DISTINCT g.\"GenreId\") = (SELECT COUNT(*) FROM \"Genre\")\n)\nORDER BY c.\"CustomerId\"\nLIMIT 5;"},
            "score": 1,
            "reason": "Query ran successfully",
        },
        {
            ...
            "dataset_item_id": uuid7str(),
            "trace_id": uuid7str(),
            "input": {"question": "What is the total revenue generated by each customer in France?"},
            "output": {"output": "SELECT c.\"CustomerId\", c.\"FirstName\", c.\"LastName\", c.\"Country\", SUM(il.\"UnitPrice\" * il.\"Quantity\") AS \"TotalRevenue\"\nFROM \"Customer\" c\nJOIN \"Invoice\" i ON c.\"CustomerId\" = i.\"CustomerId\"\nJOIN \"InvoiceLine\" il ON i.\"InvoiceId\" = il.\"InvoiceId\"\nWHERE c.\"Country\" = 'France'\nGROUP BY c.\"CustomerId\"\nORDER BY \"TotalRevenue\" DESC;\nLIMIT 5;"},
            "score": 0,
        ...
        },
        {
            ...
            "dataset_item_id": uuid7str(),
            "trace_id": uuid7str(),
            "input": {"question": "How does the average revenue per sale compare between digital and physical purchases?"},
            "output": {"output": "SELECT AVG(il.UnitPrice * il.Quantity) AS AverageRevenue, mt.Name AS MediaType\nFROM InvoiceLine il\nJOIN Track t ON il.TrackId = t.TrackId\nJOIN MediaType mt ON t.MediaTypeId = mt.MediaTypeId\nGROUP BY mt.Name\nORDER BY AverageRevenue DESC\nLIMIT 2;"},
            "score": 1,
            "reason": "Query ran successfully",
        },
        {
            ...
            "dataset_item_id": uuid7str(),
            "trace_id": uuid7str(),
            "input": {"question": "Which employee has the highest average revenue per sale?"},
            "output": {"output": "SELECT e.\"FirstName\", e.\"LastName\", AVG(il.\"UnitPrice\") AS avg_revenue_per_sale\nFROM \"Employee\" e\nJOIN \"Customer\" c ON e.\"EmployeeId\" = c.\"SupportRepId\"\nJOIN \"Invoice\" i ON c.\"CustomerId\" = i.\"CustomerId\"\nJOIN \"InvoiceLine\" il ON i.\"InvoiceId\" = il.\"InvoiceId\"\nGROUP BY e.\"EmployeeId\"\nORDER BY avg_revenue_per_sale DESC\nLIMIT 1;"},
            "score": 1,
            "reason": "Query ran successfully",
        },
        {
            ...
            "dataset_item_id": uuid7str(),
            "trace_id": uuid7str(),
            "input": {"question": "What is the average revenue generated by each country?"},
            "output": {"output": "SELECT c.\"Country\", AVG(i.\"Total\") AS \"Average Revenue\"\nFROM \"Customer\" c\nJOIN \"Invoice\" i ON c.\"CustomerId\" = i.\"CustomerId\"\nGROUP BY c.\"Country\"\nORDER BY \"Average Revenue\" DESC\nLIMIT 5;"},
            "score": 1.000000000,
            "reason": "Query ran successfully",
        },
        {
            ...
            "dataset_item_id": uuid7str(),
            "trace_id": uuid7str(),
            "input": {"question": "How many unique albums have been purchased by each customer?"},
            "output": {"output": "SELECT c.\"CustomerId\", c.\"FirstName\", c.\"LastName\", COUNT(DISTINCT i.\"AlbumId\") AS \"UniqueAlbumsPurchased\"\nFROM \"Customer\" c\nJOIN \"Invoice\" i ON c.\"CustomerId\" = i.\"CustomerId\"\nJOIN \"InvoiceLine\" il ON i.\"InvoiceId\" = il.\"InvoiceId\"\nJOIN \"Track\" t ON il.\"TrackId\" = t.\"TrackId\"\nGROUP BY c.\"CustomerId\"\nORDER BY \"UniqueAlbumsPurchased\" DESC\nLIMIT 5;"},
            "score": 0,
    ...
    messages = [
        ...
        },
        {
            ...
            "payload": {
                ...
                'usage': {'completion_tokens': 394, 'prompt_tokens': 70, 'total_tokens': 464},
                'metadata': {'created_from': 'openai', 'type': 'openai_chat', 'model': 'gpt-3.5-turbo'},
                'tags': ['openai']}
        },
...
def insert_dataset_example(experiment_items):
    dataset_items = [
        {"id": x["dataset_item_id"], "input": x["input"], "source": "sdk"} for x in experiment_items
    ]
...
def insert_experiment_items(project_name, experiment_items):
    ...
    for item in experiment_items:
        messages += insert_lanchain_chain(project_name, item["trace_id"], item["input"]["question"], item["output"]["output"])
