...
class SpansClient:
    ...
    def score_batch_of_spans(
        ...
        *,
        ...
        client = OpikApi(api_key="YOUR_API_KEY", workspace_name="YOUR_WORKSPACE_NAME", )
        client.spans.score_batch_of_spans(scores=[FeedbackScoreBatchItemTracing(name='name', value=1.1, source="ui", id='id', )], )
        """
...
class AsyncSpansClient:
    ...
    async def score_batch_of_spans(
        ...
        *,
        ...
        client = AsyncOpikApi(api_key="YOUR_API_KEY", workspace_name="YOUR_WORKSPACE_NAME", )
        async def main() -> None:
            await client.spans.score_batch_of_spans(scores=[FeedbackScoreBatchItemTracing(name='name', value=1.1, source="ui", id='id', )], )
        asyncio.run(main())
        """
