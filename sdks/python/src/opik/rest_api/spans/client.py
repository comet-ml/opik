...
class SpansClient:
    ...
    def score_batch_of_spans(
        ...
        *,
        ...
        client = OpikApi(api_key="YOUR_API_KEY", workspace_name="YOUR_WORKSPACE_NAME", )
        client.spans.score_batch_of_spans(scores=[FeedbackScoreBatchItemTracing(id='id', name='name', value=1.1, source="ui", )], )
        """
...
class AsyncSpansClient:
    ...
    async def score_batch_of_spans(
        ...
        *,
        ...
        client = AsyncOpikApi(api_key="YOUR_API_KEY", workspace_name="YOUR_WORKSPACE_NAME", )
        async def main() -> None:
            await client.spans.score_batch_of_spans(scores=[FeedbackScoreBatchItemTracing(id='id', name='name', value=1.1, source="ui", )], )
        asyncio.run(main())
        """
