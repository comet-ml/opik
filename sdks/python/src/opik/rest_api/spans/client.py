...
from ..types.feedback_score_batch_tracing_item_tracing import FeedbackScoreBatchTracingItemTracing
...
class SpansClient:
    ...
    def score_batch_of_spans(
        self,
        *,
        scores: typing.Sequence[FeedbackScoreBatchTracingItemTracing],
        request_options: typing.Optional[RequestOptions] = None,
    ) -> None:
        """
        ...
        --------
        from Opik import OpikApi
        from Opik import FeedbackScoreBatchTracingItemTracing
        client = OpikApi(api_key="YOUR_API_KEY", workspace_name="YOUR_WORKSPACE_NAME", )
        client.spans.score_batch_of_spans(scores=[FeedbackScoreBatchTracingItemTracing(name='name', value=1.1, source="ui", )], )
        """
...
class AsyncSpansClient:
    ...
    async def score_batch_of_spans(
        ...
        *,
        ...
        client = AsyncOpikApi(api_key="YOUR_API_KEY", workspace_name="YOUR_WORKSPACE_NAME", )
        async def main() -> None:
            await client.spans.score_batch_of_spans(scores=[FeedbackScoreBatchTracingItemTracing(name='name', value=1.1, source="ui", )], )
        asyncio.run(main())
        """
