...
class RawEnvironmentsClient:
    ...
    ) -> HttpResponse[EnvironmentPagePublic]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=EnvironmentPagePublic,  # type: ignore
    ...
    def get_environment_by_id(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/environments/{jsonable_encoder(id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawEnvironmentsClient:
    ...
    async def find_environments(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[EnvironmentPagePublic]:
        """
        Find environments for the workspace. Capped at the workspace limit (default 20).
