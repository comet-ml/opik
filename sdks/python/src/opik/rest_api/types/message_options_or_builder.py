...
class MessageOptionsOrBuilder(UniversalBaseModel):
...
update_forward_refs(Declaration, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    DeclarationOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(Descriptor, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(DescriptorProto, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    DescriptorProtoOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(EditionDefault, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    EditionDefaultOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(EnumDescriptor, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    EnumDescriptorProto, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(
    EnumDescriptorProtoOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(EnumOptions, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    EnumOptionsOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(EnumReservedRange, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    EnumReservedRangeOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(
    EnumValueDescriptor, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(
    EnumValueDescriptorProto, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(
    EnumValueDescriptorProtoOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(EnumValueOptions, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    EnumValueOptionsOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(ExtensionRange, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    ExtensionRangeOptions, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(
    ExtensionRangeOptionsOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(
    ExtensionRangeOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(FeatureSet, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    FeatureSetOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(FeatureSupport, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    FeatureSupportOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(FieldDescriptor, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    FieldDescriptorProto, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(
    FieldDescriptorProtoOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(FieldOptions, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    FieldOptionsOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(FileDescriptor, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    FileDescriptorProto, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(FileOptions, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    FileOptionsOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(Location, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(LocationOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(Message, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(MessageLite, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(MessageOptions, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(MethodDescriptor, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    MethodDescriptorProto, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(
    MethodDescriptorProtoOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(MethodOptions, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    MethodOptionsOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(NamePart, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(NamePartOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(OneofDescriptor, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    OneofDescriptorProto, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(
    OneofDescriptorProtoOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(OneofOptions, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    OneofOptionsOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(ReservedRange, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    ReservedRangeOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(ServiceDescriptor, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    ServiceDescriptorProto, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(
    ServiceDescriptorProtoOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(ServiceOptions, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    ServiceOptionsOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(SourceCodeInfo, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(
    SourceCodeInfoOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(
    UninterpretedOption, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(
    UninterpretedOptionOrBuilder, MessageOptionsOrBuilder=MessageOptionsOrBuilder
)
update_forward_refs(UnknownFieldSet, MessageOptionsOrBuilder=MessageOptionsOrBuilder)
update_forward_refs(MessageOptionsOrBuilder)
