...
class MethodOptions(UniversalBaseModel):
    ...
    default_instance_for_type: typing_extensions.Annotated[
        typing.Optional["MethodOptions"], FieldMetadata(alias="defaultInstanceForType")
    ] = None
    ...
    idempotency_level: typing_extensions.Annotated[
        typing.Optional[MethodOptionsIdempotencyLevel],
    ...
    parser_for_type: typing_extensions.Annotated[
        typing.Optional[ParserMethodOptions], FieldMetadata(alias="parserForType")
    ] = None
...
update_forward_refs(UnknownFieldSet, MethodOptions=MethodOptions)
update_forward_refs(Declaration, MethodOptions=MethodOptions)
update_forward_refs(DeclarationOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(Descriptor, MethodOptions=MethodOptions)
update_forward_refs(DescriptorProto, MethodOptions=MethodOptions)
update_forward_refs(DescriptorProtoOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(EditionDefault, MethodOptions=MethodOptions)
update_forward_refs(EditionDefaultOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(EnumDescriptor, MethodOptions=MethodOptions)
update_forward_refs(EnumDescriptorProto, MethodOptions=MethodOptions)
update_forward_refs(EnumDescriptorProtoOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(EnumOptions, MethodOptions=MethodOptions)
update_forward_refs(EnumOptionsOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(EnumReservedRange, MethodOptions=MethodOptions)
update_forward_refs(EnumReservedRangeOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(EnumValueDescriptor, MethodOptions=MethodOptions)
update_forward_refs(EnumValueDescriptorProto, MethodOptions=MethodOptions)
update_forward_refs(EnumValueDescriptorProtoOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(EnumValueOptions, MethodOptions=MethodOptions)
update_forward_refs(EnumValueOptionsOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(ExtensionRange, MethodOptions=MethodOptions)
update_forward_refs(ExtensionRangeOptions, MethodOptions=MethodOptions)
update_forward_refs(ExtensionRangeOptionsOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(ExtensionRangeOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(FeatureSet, MethodOptions=MethodOptions)
update_forward_refs(FeatureSetOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(FeatureSupport, MethodOptions=MethodOptions)
update_forward_refs(FeatureSupportOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(FieldDescriptor, MethodOptions=MethodOptions)
update_forward_refs(FieldDescriptorProto, MethodOptions=MethodOptions)
update_forward_refs(FieldDescriptorProtoOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(FieldOptions, MethodOptions=MethodOptions)
update_forward_refs(FieldOptionsOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(FileDescriptor, MethodOptions=MethodOptions)
update_forward_refs(FileDescriptorProto, MethodOptions=MethodOptions)
update_forward_refs(FileOptions, MethodOptions=MethodOptions)
update_forward_refs(FileOptionsOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(Location, MethodOptions=MethodOptions)
update_forward_refs(LocationOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(Message, MethodOptions=MethodOptions)
update_forward_refs(MessageLite, MethodOptions=MethodOptions)
update_forward_refs(MessageOptions, MethodOptions=MethodOptions)
update_forward_refs(MessageOptionsOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(MethodDescriptor, MethodOptions=MethodOptions)
update_forward_refs(MethodDescriptorProto, MethodOptions=MethodOptions)
update_forward_refs(MethodDescriptorProtoOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(MethodOptionsOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(NamePart, MethodOptions=MethodOptions)
update_forward_refs(NamePartOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(OneofDescriptor, MethodOptions=MethodOptions)
update_forward_refs(OneofDescriptorProto, MethodOptions=MethodOptions)
update_forward_refs(OneofDescriptorProtoOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(OneofOptions, MethodOptions=MethodOptions)
update_forward_refs(OneofOptionsOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(ReservedRange, MethodOptions=MethodOptions)
update_forward_refs(ReservedRangeOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(ServiceDescriptor, MethodOptions=MethodOptions)
update_forward_refs(ServiceDescriptorProto, MethodOptions=MethodOptions)
update_forward_refs(ServiceDescriptorProtoOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(ServiceOptions, MethodOptions=MethodOptions)
update_forward_refs(ServiceOptionsOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(SourceCodeInfo, MethodOptions=MethodOptions)
update_forward_refs(SourceCodeInfoOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(UninterpretedOption, MethodOptions=MethodOptions)
update_forward_refs(UninterpretedOptionOrBuilder, MethodOptions=MethodOptions)
update_forward_refs(MethodOptions)
