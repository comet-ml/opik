...
class ConfigurationPublicTimeoutToMarkThreadAsInactiveUnitsItem(UniversalBaseModel):
    duration_estimated: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="durationEstimated")] = (
        None
    )
    duration: typing.Optional[ConfigurationPublicTimeoutToMarkThreadAsInactiveUnitsItemDuration] = None
