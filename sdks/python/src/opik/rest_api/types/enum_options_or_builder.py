...
class EnumOptionsOrBuilder(UniversalBaseModel):
    ...
    allow_alias: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="allowAlias")
    ] = None
...
update_forward_refs(Declaration, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(DeclarationOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(Descriptor, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(DescriptorProto, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(DescriptorProtoOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(EditionDefault, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(EditionDefaultOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(EnumDescriptor, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(EnumDescriptorProto, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(
    EnumDescriptorProtoOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder
)
update_forward_refs(EnumOptions, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(EnumReservedRange, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(
    EnumReservedRangeOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder
)
update_forward_refs(EnumValueDescriptor, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(EnumValueDescriptorProto, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(
    EnumValueDescriptorProtoOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder
)
update_forward_refs(EnumValueOptions, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(
    EnumValueOptionsOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder
)
update_forward_refs(ExtensionRange, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(ExtensionRangeOptions, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(
    ExtensionRangeOptionsOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder
)
update_forward_refs(ExtensionRangeOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(FeatureSet, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(FeatureSetOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(FeatureSupport, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(FeatureSupportOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(FieldDescriptor, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(FieldDescriptorProto, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(
    FieldDescriptorProtoOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder
)
update_forward_refs(FieldOptions, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(FieldOptionsOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(FileDescriptor, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(FileDescriptorProto, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(FileOptions, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(FileOptionsOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(Location, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(LocationOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(Message, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(MessageLite, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(MessageOptions, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(MessageOptionsOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(MethodDescriptor, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(MethodDescriptorProto, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(
    MethodDescriptorProtoOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder
)
update_forward_refs(MethodOptions, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(MethodOptionsOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(NamePart, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(NamePartOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(OneofDescriptor, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(OneofDescriptorProto, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(
    OneofDescriptorProtoOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder
)
update_forward_refs(OneofOptions, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(OneofOptionsOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(ReservedRange, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(ReservedRangeOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(ServiceDescriptor, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(ServiceDescriptorProto, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(
    ServiceDescriptorProtoOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder
)
update_forward_refs(ServiceOptions, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(ServiceOptionsOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(SourceCodeInfo, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(SourceCodeInfoOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(UninterpretedOption, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(
    UninterpretedOptionOrBuilder, EnumOptionsOrBuilder=EnumOptionsOrBuilder
)
update_forward_refs(UnknownFieldSet, EnumOptionsOrBuilder=EnumOptionsOrBuilder)
update_forward_refs(EnumOptionsOrBuilder)
