...
class ConfigurationTimeoutToMarkThreadAsInactive(UniversalBaseModel):
    """
    ...
    units: typing.Optional[typing.List[ConfigurationTimeoutToMarkThreadAsInactiveUnitsItem]] = None
