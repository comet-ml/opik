...
class ProviderAuthConfigWrite(UniversalBaseModel):
    """
    ...
    send_as: typing.Optional[ProviderAuthConfigWriteSendAs] = pydantic.Field(default=None)
    """
    ...
    credentials: typing.Optional[typing.List[CredentialWrite]] = pydantic.Field(default=None)
    """
