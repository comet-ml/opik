...
class OneofOptionsOrBuilder(UniversalBaseModel):
...
update_forward_refs(Declaration, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(DeclarationOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(Descriptor, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(DescriptorProto, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    DescriptorProtoOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(EditionDefault, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    EditionDefaultOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(EnumDescriptor, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(EnumDescriptorProto, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    EnumDescriptorProtoOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(EnumOptions, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(EnumOptionsOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(EnumReservedRange, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    EnumReservedRangeOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(EnumValueDescriptor, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    EnumValueDescriptorProto, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(
    EnumValueDescriptorProtoOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(EnumValueOptions, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    EnumValueOptionsOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(ExtensionRange, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(ExtensionRangeOptions, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    ExtensionRangeOptionsOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(
    ExtensionRangeOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(FeatureSet, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(FeatureSetOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(FeatureSupport, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    FeatureSupportOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(FieldDescriptor, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(FieldDescriptorProto, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    FieldDescriptorProtoOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(FieldOptions, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(FieldOptionsOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(FileDescriptor, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(FileDescriptorProto, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(FileOptions, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(FileOptionsOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(Location, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(LocationOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(Message, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(MessageLite, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(MessageOptions, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    MessageOptionsOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(MethodDescriptor, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(MethodDescriptorProto, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    MethodDescriptorProtoOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(MethodOptions, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(MethodOptionsOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(NamePart, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(NamePartOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(OneofDescriptor, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(OneofDescriptorProto, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    OneofDescriptorProtoOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(OneofOptions, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(ReservedRange, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(ReservedRangeOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(ServiceDescriptor, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(ServiceDescriptorProto, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    ServiceDescriptorProtoOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(ServiceOptions, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    ServiceOptionsOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(SourceCodeInfo, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    SourceCodeInfoOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(UninterpretedOption, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(
    UninterpretedOptionOrBuilder, OneofOptionsOrBuilder=OneofOptionsOrBuilder
)
update_forward_refs(UnknownFieldSet, OneofOptionsOrBuilder=OneofOptionsOrBuilder)
update_forward_refs(OneofOptionsOrBuilder)
