...
class ServiceOptions(UniversalBaseModel):
    ...
    default_instance_for_type: typing_extensions.Annotated[
        typing.Optional["ServiceOptions"], FieldMetadata(alias="defaultInstanceForType")
    ] = None
    ...
    parser_for_type: typing_extensions.Annotated[
        typing.Optional[ParserServiceOptions], FieldMetadata(alias="parserForType")
    ] = None
...
update_forward_refs(UnknownFieldSet, ServiceOptions=ServiceOptions)
update_forward_refs(Declaration, ServiceOptions=ServiceOptions)
update_forward_refs(DeclarationOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(Descriptor, ServiceOptions=ServiceOptions)
update_forward_refs(DescriptorProto, ServiceOptions=ServiceOptions)
update_forward_refs(DescriptorProtoOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(EditionDefault, ServiceOptions=ServiceOptions)
update_forward_refs(EditionDefaultOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(EnumDescriptor, ServiceOptions=ServiceOptions)
update_forward_refs(EnumDescriptorProto, ServiceOptions=ServiceOptions)
update_forward_refs(EnumDescriptorProtoOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(EnumOptions, ServiceOptions=ServiceOptions)
update_forward_refs(EnumOptionsOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(EnumReservedRange, ServiceOptions=ServiceOptions)
update_forward_refs(EnumReservedRangeOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(EnumValueDescriptor, ServiceOptions=ServiceOptions)
update_forward_refs(EnumValueDescriptorProto, ServiceOptions=ServiceOptions)
update_forward_refs(EnumValueDescriptorProtoOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(EnumValueOptions, ServiceOptions=ServiceOptions)
update_forward_refs(EnumValueOptionsOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(ExtensionRange, ServiceOptions=ServiceOptions)
update_forward_refs(ExtensionRangeOptions, ServiceOptions=ServiceOptions)
update_forward_refs(ExtensionRangeOptionsOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(ExtensionRangeOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(FeatureSet, ServiceOptions=ServiceOptions)
update_forward_refs(FeatureSetOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(FeatureSupport, ServiceOptions=ServiceOptions)
update_forward_refs(FeatureSupportOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(FieldDescriptor, ServiceOptions=ServiceOptions)
update_forward_refs(FieldDescriptorProto, ServiceOptions=ServiceOptions)
update_forward_refs(FieldDescriptorProtoOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(FieldOptions, ServiceOptions=ServiceOptions)
update_forward_refs(FieldOptionsOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(FileDescriptor, ServiceOptions=ServiceOptions)
update_forward_refs(FileDescriptorProto, ServiceOptions=ServiceOptions)
update_forward_refs(FileOptions, ServiceOptions=ServiceOptions)
update_forward_refs(FileOptionsOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(Location, ServiceOptions=ServiceOptions)
update_forward_refs(LocationOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(Message, ServiceOptions=ServiceOptions)
update_forward_refs(MessageLite, ServiceOptions=ServiceOptions)
update_forward_refs(MessageOptions, ServiceOptions=ServiceOptions)
update_forward_refs(MessageOptionsOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(MethodDescriptor, ServiceOptions=ServiceOptions)
update_forward_refs(MethodDescriptorProto, ServiceOptions=ServiceOptions)
update_forward_refs(MethodDescriptorProtoOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(MethodOptions, ServiceOptions=ServiceOptions)
update_forward_refs(MethodOptionsOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(NamePart, ServiceOptions=ServiceOptions)
update_forward_refs(NamePartOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(OneofDescriptor, ServiceOptions=ServiceOptions)
update_forward_refs(OneofDescriptorProto, ServiceOptions=ServiceOptions)
update_forward_refs(OneofDescriptorProtoOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(OneofOptions, ServiceOptions=ServiceOptions)
update_forward_refs(OneofOptionsOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(ReservedRange, ServiceOptions=ServiceOptions)
update_forward_refs(ReservedRangeOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(ServiceDescriptor, ServiceOptions=ServiceOptions)
update_forward_refs(ServiceDescriptorProto, ServiceOptions=ServiceOptions)
update_forward_refs(ServiceDescriptorProtoOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(ServiceOptionsOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(SourceCodeInfo, ServiceOptions=ServiceOptions)
update_forward_refs(SourceCodeInfoOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(UninterpretedOption, ServiceOptions=ServiceOptions)
update_forward_refs(UninterpretedOptionOrBuilder, ServiceOptions=ServiceOptions)
update_forward_refs(ServiceOptions)
