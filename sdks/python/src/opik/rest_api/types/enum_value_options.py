...
class EnumValueOptions(UniversalBaseModel):
    ...
    default_instance_for_type: typing_extensions.Annotated[
        typing.Optional["EnumValueOptions"],
    ...
    parser_for_type: typing_extensions.Annotated[
        typing.Optional[ParserEnumValueOptions], FieldMetadata(alias="parserForType")
    ] = None
...
update_forward_refs(UnknownFieldSet, EnumValueOptions=EnumValueOptions)
update_forward_refs(Declaration, EnumValueOptions=EnumValueOptions)
update_forward_refs(DeclarationOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(Descriptor, EnumValueOptions=EnumValueOptions)
update_forward_refs(DescriptorProto, EnumValueOptions=EnumValueOptions)
update_forward_refs(DescriptorProtoOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(EditionDefault, EnumValueOptions=EnumValueOptions)
update_forward_refs(EditionDefaultOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(EnumDescriptor, EnumValueOptions=EnumValueOptions)
update_forward_refs(EnumDescriptorProto, EnumValueOptions=EnumValueOptions)
update_forward_refs(EnumDescriptorProtoOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(EnumOptions, EnumValueOptions=EnumValueOptions)
update_forward_refs(EnumOptionsOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(EnumReservedRange, EnumValueOptions=EnumValueOptions)
update_forward_refs(EnumReservedRangeOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(EnumValueDescriptor, EnumValueOptions=EnumValueOptions)
update_forward_refs(EnumValueDescriptorProto, EnumValueOptions=EnumValueOptions)
update_forward_refs(
    EnumValueDescriptorProtoOrBuilder, EnumValueOptions=EnumValueOptions
)
update_forward_refs(EnumValueOptionsOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(ExtensionRange, EnumValueOptions=EnumValueOptions)
update_forward_refs(ExtensionRangeOptions, EnumValueOptions=EnumValueOptions)
update_forward_refs(ExtensionRangeOptionsOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(ExtensionRangeOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(FeatureSet, EnumValueOptions=EnumValueOptions)
update_forward_refs(FeatureSetOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(FeatureSupport, EnumValueOptions=EnumValueOptions)
update_forward_refs(FeatureSupportOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(FieldDescriptor, EnumValueOptions=EnumValueOptions)
update_forward_refs(FieldDescriptorProto, EnumValueOptions=EnumValueOptions)
update_forward_refs(FieldDescriptorProtoOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(FieldOptions, EnumValueOptions=EnumValueOptions)
update_forward_refs(FieldOptionsOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(FileDescriptor, EnumValueOptions=EnumValueOptions)
update_forward_refs(FileDescriptorProto, EnumValueOptions=EnumValueOptions)
update_forward_refs(FileOptions, EnumValueOptions=EnumValueOptions)
update_forward_refs(FileOptionsOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(Location, EnumValueOptions=EnumValueOptions)
update_forward_refs(LocationOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(Message, EnumValueOptions=EnumValueOptions)
update_forward_refs(MessageLite, EnumValueOptions=EnumValueOptions)
update_forward_refs(MessageOptions, EnumValueOptions=EnumValueOptions)
update_forward_refs(MessageOptionsOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(MethodDescriptor, EnumValueOptions=EnumValueOptions)
update_forward_refs(MethodDescriptorProto, EnumValueOptions=EnumValueOptions)
update_forward_refs(MethodDescriptorProtoOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(MethodOptions, EnumValueOptions=EnumValueOptions)
update_forward_refs(MethodOptionsOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(NamePart, EnumValueOptions=EnumValueOptions)
update_forward_refs(NamePartOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(OneofDescriptor, EnumValueOptions=EnumValueOptions)
update_forward_refs(OneofDescriptorProto, EnumValueOptions=EnumValueOptions)
update_forward_refs(OneofDescriptorProtoOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(OneofOptions, EnumValueOptions=EnumValueOptions)
update_forward_refs(OneofOptionsOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(ReservedRange, EnumValueOptions=EnumValueOptions)
update_forward_refs(ReservedRangeOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(ServiceDescriptor, EnumValueOptions=EnumValueOptions)
update_forward_refs(ServiceDescriptorProto, EnumValueOptions=EnumValueOptions)
update_forward_refs(ServiceDescriptorProtoOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(ServiceOptions, EnumValueOptions=EnumValueOptions)
update_forward_refs(ServiceOptionsOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(SourceCodeInfo, EnumValueOptions=EnumValueOptions)
update_forward_refs(SourceCodeInfoOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(UninterpretedOption, EnumValueOptions=EnumValueOptions)
update_forward_refs(UninterpretedOptionOrBuilder, EnumValueOptions=EnumValueOptions)
update_forward_refs(EnumValueOptions)
