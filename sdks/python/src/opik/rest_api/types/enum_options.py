...
class EnumOptions(UniversalBaseModel):
    ...
    default_instance_for_type: typing_extensions.Annotated[
        typing.Optional["EnumOptions"], FieldMetadata(alias="defaultInstanceForType")
    ] = None
    ...
    parser_for_type: typing_extensions.Annotated[
        typing.Optional[ParserEnumOptions], FieldMetadata(alias="parserForType")
    ] = None
...
update_forward_refs(UnknownFieldSet, EnumOptions=EnumOptions)
update_forward_refs(Declaration, EnumOptions=EnumOptions)
update_forward_refs(DeclarationOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(Descriptor, EnumOptions=EnumOptions)
update_forward_refs(DescriptorProto, EnumOptions=EnumOptions)
update_forward_refs(DescriptorProtoOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(EditionDefault, EnumOptions=EnumOptions)
update_forward_refs(EditionDefaultOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(EnumDescriptor, EnumOptions=EnumOptions)
update_forward_refs(EnumDescriptorProto, EnumOptions=EnumOptions)
update_forward_refs(EnumDescriptorProtoOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(EnumOptionsOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(EnumReservedRange, EnumOptions=EnumOptions)
update_forward_refs(EnumReservedRangeOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(EnumValueDescriptor, EnumOptions=EnumOptions)
update_forward_refs(EnumValueDescriptorProto, EnumOptions=EnumOptions)
update_forward_refs(EnumValueDescriptorProtoOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(EnumValueOptions, EnumOptions=EnumOptions)
update_forward_refs(EnumValueOptionsOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(ExtensionRange, EnumOptions=EnumOptions)
update_forward_refs(ExtensionRangeOptions, EnumOptions=EnumOptions)
update_forward_refs(ExtensionRangeOptionsOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(ExtensionRangeOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(FeatureSet, EnumOptions=EnumOptions)
update_forward_refs(FeatureSetOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(FeatureSupport, EnumOptions=EnumOptions)
update_forward_refs(FeatureSupportOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(FieldDescriptor, EnumOptions=EnumOptions)
update_forward_refs(FieldDescriptorProto, EnumOptions=EnumOptions)
update_forward_refs(FieldDescriptorProtoOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(FieldOptions, EnumOptions=EnumOptions)
update_forward_refs(FieldOptionsOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(FileDescriptor, EnumOptions=EnumOptions)
update_forward_refs(FileDescriptorProto, EnumOptions=EnumOptions)
update_forward_refs(FileOptions, EnumOptions=EnumOptions)
update_forward_refs(FileOptionsOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(Location, EnumOptions=EnumOptions)
update_forward_refs(LocationOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(Message, EnumOptions=EnumOptions)
update_forward_refs(MessageLite, EnumOptions=EnumOptions)
update_forward_refs(MessageOptions, EnumOptions=EnumOptions)
update_forward_refs(MessageOptionsOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(MethodDescriptor, EnumOptions=EnumOptions)
update_forward_refs(MethodDescriptorProto, EnumOptions=EnumOptions)
update_forward_refs(MethodDescriptorProtoOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(MethodOptions, EnumOptions=EnumOptions)
update_forward_refs(MethodOptionsOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(NamePart, EnumOptions=EnumOptions)
update_forward_refs(NamePartOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(OneofDescriptor, EnumOptions=EnumOptions)
update_forward_refs(OneofDescriptorProto, EnumOptions=EnumOptions)
update_forward_refs(OneofDescriptorProtoOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(OneofOptions, EnumOptions=EnumOptions)
update_forward_refs(OneofOptionsOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(ReservedRange, EnumOptions=EnumOptions)
update_forward_refs(ReservedRangeOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(ServiceDescriptor, EnumOptions=EnumOptions)
update_forward_refs(ServiceDescriptorProto, EnumOptions=EnumOptions)
update_forward_refs(ServiceDescriptorProtoOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(ServiceOptions, EnumOptions=EnumOptions)
update_forward_refs(ServiceOptionsOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(SourceCodeInfo, EnumOptions=EnumOptions)
update_forward_refs(SourceCodeInfoOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(UninterpretedOption, EnumOptions=EnumOptions)
update_forward_refs(UninterpretedOptionOrBuilder, EnumOptions=EnumOptions)
update_forward_refs(EnumOptions)
