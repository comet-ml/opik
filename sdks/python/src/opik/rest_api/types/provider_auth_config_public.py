...
class ProviderAuthConfigPublic(UniversalBaseModel):
    """
    ...
    send_as: typing.Optional[ProviderAuthConfigPublicSendAs] = pydantic.Field(default=None)
    """
    ...
    credentials: typing.Optional[typing.List[CredentialPublic]] = pydantic.Field(default=None)
    """
