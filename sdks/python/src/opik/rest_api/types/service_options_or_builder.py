...
class ServiceOptionsOrBuilder(UniversalBaseModel):
...
update_forward_refs(Declaration, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    DeclarationOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(Descriptor, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(DescriptorProto, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    DescriptorProtoOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(EditionDefault, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    EditionDefaultOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(EnumDescriptor, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    EnumDescriptorProto, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(
    EnumDescriptorProtoOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(EnumOptions, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    EnumOptionsOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(EnumReservedRange, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    EnumReservedRangeOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(
    EnumValueDescriptor, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(
    EnumValueDescriptorProto, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(
    EnumValueDescriptorProtoOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(EnumValueOptions, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    EnumValueOptionsOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(ExtensionRange, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    ExtensionRangeOptions, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(
    ExtensionRangeOptionsOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(
    ExtensionRangeOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(FeatureSet, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    FeatureSetOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(FeatureSupport, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    FeatureSupportOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(FieldDescriptor, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    FieldDescriptorProto, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(
    FieldDescriptorProtoOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(FieldOptions, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    FieldOptionsOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(FileDescriptor, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    FileDescriptorProto, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(FileOptions, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    FileOptionsOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(Location, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(LocationOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(Message, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(MessageLite, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(MessageOptions, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    MessageOptionsOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(MethodDescriptor, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    MethodDescriptorProto, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(
    MethodDescriptorProtoOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(MethodOptions, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    MethodOptionsOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(NamePart, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(NamePartOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(OneofDescriptor, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    OneofDescriptorProto, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(
    OneofDescriptorProtoOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(OneofOptions, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    OneofOptionsOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(ReservedRange, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    ReservedRangeOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(ServiceDescriptor, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    ServiceDescriptorProto, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(
    ServiceDescriptorProtoOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(ServiceOptions, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(SourceCodeInfo, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(
    SourceCodeInfoOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(
    UninterpretedOption, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(
    UninterpretedOptionOrBuilder, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder
)
update_forward_refs(UnknownFieldSet, ServiceOptionsOrBuilder=ServiceOptionsOrBuilder)
update_forward_refs(ServiceOptionsOrBuilder)
