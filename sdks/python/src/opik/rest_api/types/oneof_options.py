...
class OneofOptions(UniversalBaseModel):
    ...
    default_instance_for_type: typing_extensions.Annotated[
        typing.Optional["OneofOptions"], FieldMetadata(alias="defaultInstanceForType")
    ] = None
    ...
    parser_for_type: typing_extensions.Annotated[
        typing.Optional[ParserOneofOptions], FieldMetadata(alias="parserForType")
    ] = None
...
update_forward_refs(UnknownFieldSet, OneofOptions=OneofOptions)
update_forward_refs(Declaration, OneofOptions=OneofOptions)
update_forward_refs(DeclarationOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(Descriptor, OneofOptions=OneofOptions)
update_forward_refs(DescriptorProto, OneofOptions=OneofOptions)
update_forward_refs(DescriptorProtoOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(EditionDefault, OneofOptions=OneofOptions)
update_forward_refs(EditionDefaultOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(EnumDescriptor, OneofOptions=OneofOptions)
update_forward_refs(EnumDescriptorProto, OneofOptions=OneofOptions)
update_forward_refs(EnumDescriptorProtoOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(EnumOptions, OneofOptions=OneofOptions)
update_forward_refs(EnumOptionsOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(EnumReservedRange, OneofOptions=OneofOptions)
update_forward_refs(EnumReservedRangeOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(EnumValueDescriptor, OneofOptions=OneofOptions)
update_forward_refs(EnumValueDescriptorProto, OneofOptions=OneofOptions)
update_forward_refs(EnumValueDescriptorProtoOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(EnumValueOptions, OneofOptions=OneofOptions)
update_forward_refs(EnumValueOptionsOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(ExtensionRange, OneofOptions=OneofOptions)
update_forward_refs(ExtensionRangeOptions, OneofOptions=OneofOptions)
update_forward_refs(ExtensionRangeOptionsOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(ExtensionRangeOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(FeatureSet, OneofOptions=OneofOptions)
update_forward_refs(FeatureSetOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(FeatureSupport, OneofOptions=OneofOptions)
update_forward_refs(FeatureSupportOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(FieldDescriptor, OneofOptions=OneofOptions)
update_forward_refs(FieldDescriptorProto, OneofOptions=OneofOptions)
update_forward_refs(FieldDescriptorProtoOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(FieldOptions, OneofOptions=OneofOptions)
update_forward_refs(FieldOptionsOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(FileDescriptor, OneofOptions=OneofOptions)
update_forward_refs(FileDescriptorProto, OneofOptions=OneofOptions)
update_forward_refs(FileOptions, OneofOptions=OneofOptions)
update_forward_refs(FileOptionsOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(Location, OneofOptions=OneofOptions)
update_forward_refs(LocationOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(Message, OneofOptions=OneofOptions)
update_forward_refs(MessageLite, OneofOptions=OneofOptions)
update_forward_refs(MessageOptions, OneofOptions=OneofOptions)
update_forward_refs(MessageOptionsOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(MethodDescriptor, OneofOptions=OneofOptions)
update_forward_refs(MethodDescriptorProto, OneofOptions=OneofOptions)
update_forward_refs(MethodDescriptorProtoOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(MethodOptions, OneofOptions=OneofOptions)
update_forward_refs(MethodOptionsOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(NamePart, OneofOptions=OneofOptions)
update_forward_refs(NamePartOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(OneofDescriptor, OneofOptions=OneofOptions)
update_forward_refs(OneofDescriptorProto, OneofOptions=OneofOptions)
update_forward_refs(OneofDescriptorProtoOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(OneofOptionsOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(ReservedRange, OneofOptions=OneofOptions)
update_forward_refs(ReservedRangeOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(ServiceDescriptor, OneofOptions=OneofOptions)
update_forward_refs(ServiceDescriptorProto, OneofOptions=OneofOptions)
update_forward_refs(ServiceDescriptorProtoOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(ServiceOptions, OneofOptions=OneofOptions)
update_forward_refs(ServiceOptionsOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(SourceCodeInfo, OneofOptions=OneofOptions)
update_forward_refs(SourceCodeInfoOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(UninterpretedOption, OneofOptions=OneofOptions)
update_forward_refs(UninterpretedOptionOrBuilder, OneofOptions=OneofOptions)
update_forward_refs(OneofOptions)
