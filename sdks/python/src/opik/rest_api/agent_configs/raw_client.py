...
class RawAgentConfigsClient:
    ...
    def get_blueprint_by_env(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/agent-configs/blueprint/env/{jsonable_encoder(env_name)}",
            method="GET",
            params={
                "project_id": project_id,
                "mask_id": mask_id,
    ...
    def get_blueprint_by_id(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/agent-configs/blueprint/{jsonable_encoder(blueprint_id)}",
            method="GET",
            params={
                "mask_id": mask_id,
            },
    ...
    def get_blueprint_history(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/private/agent-configs/history",
            method="GET",
            params={
                "project_id": project_id,
                "page": page,
    ...
    def get_delta_by_id(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/agent-configs/delta/{jsonable_encoder(blueprint_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_latest_blueprint(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/private/agent-configs/blueprint/retrieve",
            method="GET",
            params={
                "project_id": project_id,
                "mask_id": mask_id,
