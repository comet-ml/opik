...
_SYSTEM_PROMPT = """YOU ARE THE WORLD'S LEADING EXPERT IN FACT-CHECKING AND VALIDATING INFORMATION. YOU HAVE DEVELOPED
...
def _format_examples(few_shot_examples: List[FewShotExampleFactuality]) -> str:
    return "\n\n".join(
        [
            f"Example {i + 1}:\n"
