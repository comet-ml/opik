...
from .experiment import experiments_client, experiment_item
...
class Opik:
    ...
    def find_experiment_items_for_dataset(
        ...
        """
        client = experiments_client.ExperimentsClient(self._rest_client)
        return client.find_experiment_items_for_dataset(
            dataset_name=dataset_name,
