...
COLUMNS = {
    "id": "string",
    "name": "string",
    # Prompts supported fields - only what backend test actually supports
    "description": "string",
...
SUPPORTED_OPERATORS = {
    ...
    # Only add the fields that backend test actually supports
    "description": ["=", "!="],
    "created_at": ["=", "!=", ">"],
    "last_updated_at": [">=", "<", "<="],
    "created_by": ["starts_with", "="],
    "last_updated_by": ["!=", "contains"],
