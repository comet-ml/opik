...
export class Experiments {
     ...
     *
     * @example
     *     await client.experiments.updateExperimentById({
     *         id: "the-id",
     *         name: "new-name",
     *         metadata: { k: "v" }
     *     })
     */
    public updateExperimentById(
        id: string,
        request: OpikApi.UpdateExperimentRequest,
        requestOptions?: Experiments.RequestOptions,
    ): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(
            this.__updateExperimentById(id, request, requestOptions),
        );
    }

    private async __updateExperimentById(
    id:string,
    request: OpikApi.UpdateExperimentRequest,
    requestOptions?: Experiments.RequestOptions,
    ): Promise<core.WithRawResponse<void>> {
    const _response = await core.fetcher({
        ...
        headers: {
        "Comet-Workspace":
            (await core.Supplier.get(this._options.workspaceName)) ?? undefined,
        "X-Fern-Language": "JavaScript",
        "X-Fern-Runtime": core.RUNTIME.type,
        "X-Fern-Runtime-Version": core.RUNTIME.version,
        ...(await this._getCustomAuthorizationHeaders()),
        ...
        contentType: "application/json",
        requestType: "json",
        body: serializers.UpdateExperimentRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
        timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
        maxRetries: requestOptions?.maxRetries,
        withCredentials: true,
        abortSignal: requestOptions?.abortSignal,
    ...
    switch (_response.error.reason) {
        ...
        case "timeout":
        throw new errors.OpikApiTimeoutError(
            `Timeout exceeded when calling POST /v1/private/experiments/update/${id}.`,
        );
        case "unknown":
        throw new errors.OpikApiError({
            message: _response.error.errorMessage,
    ...
    private async __findExperimentGroups(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.OpikApiTimeoutError(
                    "Timeout exceeded when calling GET /v1/private/experiments/groups.",
                );
            case "unknown":
                throw new errors.OpikApiError({
                    message: _response.error.errorMessage,
    ...
    private async __findExperimentGroupsAggregations(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.OpikApiTimeoutError(
                    "Timeout exceeded when calling GET /v1/private/experiments/groups/aggregations.",
                );
            case "unknown":
                throw new errors.OpikApiError({
                    message: _response.error.errorMessage,
    ...
    private async __finishExperiments(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.OpikApiTimeoutError(
                    "Timeout exceeded when calling POST /v1/private/experiments/finish.",
                );
            case "unknown":
                throw new errors.OpikApiError({
                    message: _response.error.errorMessage,
    ...
    private async __updateExperiment(
        ...
        const _response = await core.fetcher({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.ExperimentUpdate.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            withCredentials: true,
            abortSignal: requestOptions?.abortSignal,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.OpikApiTimeoutError(
                    "Timeout exceeded when calling PATCH /v1/private/experiments/{id}.",
                );
            case "unknown":
                throw new errors.OpikApiError({
                    message: _response.error.errorMessage,
