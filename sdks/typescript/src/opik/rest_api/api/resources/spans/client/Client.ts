...
export class Spans {
     ...
     *
     * @param {OpikApi.FeedbackScoreBatchTracingTracing} request
     * @param {Spans.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public scoreBatchOfSpans(
        request: OpikApi.FeedbackScoreBatchTracingTracing,
        requestOptions?: Spans.RequestOptions,
    ): core.HttpResponsePromise<void> {
    ...
    private async __scoreBatchOfSpans(
        ...
        const _response = await core.fetcher({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.FeedbackScoreBatchTracingTracing.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
