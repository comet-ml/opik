...
export declare namespace ServiceTogglesClient {
 ...
 */
export class ServiceTogglesClient {
    ...
    public getServiceToggles(
        requestOptions?: ServiceTogglesClient.RequestOptions,
    ...
    private async __getServiceToggles(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/private/toggles");
    }
}
