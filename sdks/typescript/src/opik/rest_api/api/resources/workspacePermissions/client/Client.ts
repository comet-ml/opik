...
export declare namespace WorkspacePermissionsClient {
 ...
 */
export class WorkspacePermissionsClient {
     ...
     */
    public getWorkspaceUserPermissions(
        requestOptions?: WorkspacePermissionsClient.RequestOptions,
    ): core.HttpResponsePromise<OpikApi.WorkspaceUserPermissions> {
        return core.HttpResponsePromise.fromPromise(this.__getWorkspaceUserPermissions(requestOptions));
    }

    private async __getWorkspaceUserPermissions(
        requestOptions?: WorkspacePermissionsClient.RequestOptions,
    ): Promise<core.WithRawResponse<OpikApi.WorkspaceUserPermissions>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.WorkspaceUserPermissions.parseOrThrow(_response.body, {
