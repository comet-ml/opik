...
export class Traces {
     ...
     *
     * @param {OpikApi.FeedbackScoreBatchTracingThread} request
     * @param {Traces.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public scoreBatchOfThreads(
        request: OpikApi.FeedbackScoreBatchTracingThread,
        requestOptions?: Traces.RequestOptions,
    ): core.HttpResponsePromise<void> {
    ...
    private async __scoreBatchOfThreads(
        ...
        const _response = await core.fetcher({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.FeedbackScoreBatchTracingThread.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            withCredentials: true,
            abortSignal: requestOptions?.abortSignal,
