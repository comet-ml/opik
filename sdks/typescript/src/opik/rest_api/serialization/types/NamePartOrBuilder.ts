...
export const NamePartOrBuilder: core.serialization.ObjectSchema<
    serializers.NamePartOrBuilder.Raw,
    OpikApi.NamePartOrBuilder
...
export declare namespace NamePartOrBuilder {
