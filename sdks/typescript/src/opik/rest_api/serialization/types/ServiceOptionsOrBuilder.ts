...
export const ServiceOptionsOrBuilder: core.serialization.ObjectSchema<
    serializers.ServiceOptionsOrBuilder.Raw,
    OpikApi.ServiceOptionsOrBuilder
...
export declare namespace ServiceOptionsOrBuilder {
