...
export const Event: core.serialization.ObjectSchema<serializers.Event.Raw, OpikApi.Event> = core.serialization.object({
    unknownFields: core.serialization.lazyObject(() => serializers.UnknownFieldSet).optional(),
    name: core.serialization.string().optional(),
    defaultInstanceForType: core.serialization.lazyObject(() => serializers.Event).optional(),
    ...
    parserForType: ParserEvent.optional(),
...
export declare namespace Event {
    export interface Raw {
        ...
        name?: string | null;
        defaultInstanceForType?: serializers.Event.Raw | null;
        ...
        parserForType?: ParserEvent.Raw | null;
