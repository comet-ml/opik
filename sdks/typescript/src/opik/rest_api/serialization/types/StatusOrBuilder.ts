...
import { StatusOrBuilderCode } from "./StatusOrBuilderCode";

export const StatusOrBuilder: core.serialization.ObjectSchema<
    serializers.StatusOrBuilder.Raw,
    OpikApi.StatusOrBuilder
> = core.serialization.object({
    message: core.serialization.string().optional(),
    messageBytes: ByteString.optional(),
    codeValue: core.serialization.number().optional(),
    code: StatusOrBuilderCode.optional(),
...
export declare namespace StatusOrBuilder {
    export interface Raw {
        message?: string | null;
        messageBytes?: ByteString.Raw | null;
        codeValue?: number | null;
        code?: StatusOrBuilderCode.Raw | null;
