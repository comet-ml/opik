...
export const ExtensionRangeOrBuilder: core.serialization.ObjectSchema<
    serializers.ExtensionRangeOrBuilder.Raw,
    OpikApi.ExtensionRangeOrBuilder
...
export declare namespace ExtensionRangeOrBuilder {
