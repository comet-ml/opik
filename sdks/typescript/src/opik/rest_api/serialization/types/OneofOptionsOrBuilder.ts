...
export const OneofOptionsOrBuilder: core.serialization.ObjectSchema<
    serializers.OneofOptionsOrBuilder.Raw,
    OpikApi.OneofOptionsOrBuilder
...
export declare namespace OneofOptionsOrBuilder {
