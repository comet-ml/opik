 ...
 */
const DEFAULT_MODEL: SupportedModelId = "openai/gpt-5-nano";
 ...
 *
 * @param modelId - Model ID (e.g., 'openai/gpt-5-nano', 'claude-3-5-sonnet-latest', 'gemini-2.0-flash')
 ...
 * const model1 = createModel('openai/gpt-5-nano', {
 *   apiKey: 'sk-...',
...
function createInvalidModelTypeError(model: unknown): Error {
  ...
  - string (model ID like 'openai/gpt-5-nano', 'claude-3-5-sonnet-latest')
 ...
 * 1. undefined/null → Creates default model (openai/gpt-5-nano)
 ...
 *
 * // Using model ID
 * const model2 = resolveModel('openai/gpt-5-nano');
 *
 * // Using OpikBaseModel instance
 * const model3 = resolveModel(new VercelAIChatModel('openai/gpt-5-nano'));
 *
