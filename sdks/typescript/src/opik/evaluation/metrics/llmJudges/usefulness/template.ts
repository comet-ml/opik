/**
 * Generates the usefulness evaluation query for the LLM.
 *
 * @param input - The input/question that was given to the AI
 * @param output - The output/response generated by the AI
 * @returns The formatted prompt string
 */
export function generateQuery(input: string, output: string): string {
  return `
