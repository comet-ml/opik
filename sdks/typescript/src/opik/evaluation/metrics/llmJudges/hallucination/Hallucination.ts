 ...
 *
 * // Using default model (openai/gpt-5-nano)
...
export class Hallucination extends BaseLLMJudgeMetric {
   ...
   * @param options.model - The language model to use. Can be a string (model ID), LanguageModel instance, or OpikBaseModel instance. Defaults to 'openai/gpt-5-nano'.
