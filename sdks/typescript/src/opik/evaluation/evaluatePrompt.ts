...
export interface EvaluatePromptOptions extends Omit<EvaluateOptions, "task"> {
  ...
  /** Model to use for generation. Can be model ID string, LanguageModel instance, or OpikBaseModel instance. Defaults to openai/gpt-5-nano */
 ...
 *   ],
 *   model: 'openai/gpt-5-nano', // or omit to use default model
 *   temperature: 0.7,
 *   seed: 42,
