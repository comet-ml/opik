...
def test_metaprompt_optimizer():
    ...
    assert results.optimizer == "MetaPromptOptimizer", f"Expected MetaPromptOptimizer, got {results.optimizer}"
    ...
    assert len(results.details['rounds']) > 0, "Should have at least one optimization round"
