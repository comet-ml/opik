...
class TestBaseOptimizer:
    ...
    def test_optimize_prompt_signature(self):
        ...
        expected_params = [
            'self', 'prompt', 'dataset', 'metric', 
            'experiment_config', 'n_samples', 'auto_continue', 'agent_class', 'kwargs'
        ]
    ...
    def test_optimize_mcp_signature(self):
        ...
        expected_params = [
            'self', 'prompt', 'dataset', 'metric',
            'tool_name', 'second_pass', 'experiment_config', 'n_samples', 
            'auto_continue', 'agent_class', 'fallback_invoker', 'fallback_arguments', 
            'allow_tool_use_on_second_pass', 'kwargs'
        ]
