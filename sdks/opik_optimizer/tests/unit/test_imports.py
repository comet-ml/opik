...
def test_import_time_is_reasonable():
...
def test_optimizer_classes_importable():
...
def test_chat_prompt_import_and_creation():
...
def test_optimization_result_import_and_creation():
...
def test_optimizer_initialization_basic():
