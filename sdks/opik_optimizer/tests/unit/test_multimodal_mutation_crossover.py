...
import pytest
from opik_optimizer.evolutionary_optimizer.mutation_ops import (
    extract_text_from_content,
    rebuild_content_with_mutated_text,
)
from opik_optimizer.evolutionary_optimizer.crossover_ops import (
    extract_text_from_content as extract_text_crossover,
    rebuild_content_with_mutated_text as rebuild_content_crossover,
)
...
def test_rebuild_content_with_string():
    ...
    result = rebuild_content_with_mutated_text(original, mutated_text)
...
def test_rebuild_content_preserves_image_detail():
    ...
    result = rebuild_content_with_mutated_text(original, "Mutated")
...
def test_mutation_preserves_original_object():
    ...
    rebuilt = rebuild_content_with_mutated_text(original, "Mutated")
...
def test_empty_text_mutation():
    ...
    result = rebuild_content_with_mutated_text(original, "New text")
...
def test_text_only_structured_content():
    ...
    rebuilt = rebuild_content_with_mutated_text(original, "Mutated text")
...
def test_roundtrip_text_extraction_and_rebuild():
    ...
    rebuilt = rebuild_content_with_mutated_text(original, extracted)
