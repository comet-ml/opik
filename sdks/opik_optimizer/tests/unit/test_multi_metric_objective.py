...
class TestMultiMetricObjective:
    ...
    def test_final_score_is_weighted_average__three_metrics(self):
    ...
    def test_metadata_contains_raw_score_results(self):
    ...
    def test_equal_weights_when_no_weights_provided__one_metric(self):
    ...
    def test_equal_weights_when_no_weights_provided__two_metrics(self):
    ...
    def test_equal_weights_when_no_weights_provided__three_metrics(self):
    ...
    def test_default_name_is_set(self):
    ...
    def test_dataset_item_and_llm_output_are_passed_to_metrics(self):
        ...
        def tracking_metric_1(dataset_item: Dict[str, Any], llm_output: str) -> ScoreResult:
        ...
        def tracking_metric_2(dataset_item: Dict[str, Any], llm_output: str) -> ScoreResult:
    ...
    def test_zero_weight_excludes_metric_from_result(self):
