...
Usage:
    # Local execution
    python run.py --demo-datasets gsm8k --optimizers few_shot --test-mode

    # Modal execution
    python run.py --modal --demo-datasets gsm8k --optimizers few_shot --test-mode

    # Modal execution with custom concurrency
    python run.py --modal --demo-datasets gsm8k --optimizers few_shot --test-mode --max-concurrent 10
"""
