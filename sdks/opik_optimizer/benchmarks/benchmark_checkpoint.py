...
class BenchmarkCheckpointManager():
    def __init__(self, checkpoint_folder, run_id, test_mode, demo_datasets, optimizers, models):
    ...
    def load(self):
        if not os.path.exists(self.checkpoint_file):
            raise FileNotFoundError(f"Checkpoint file {self.checkpoint_file} does not exist")
