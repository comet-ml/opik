...
from benchmarks.packages.hotpot import metrics as hotpot
from benchmarks.packages.hover import metrics as hover
from benchmarks.packages.ifbench import metrics as ifbench
...
from benchmarks.packages.pupa import metrics as pupa
