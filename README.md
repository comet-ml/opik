...
Other MCP clients: `npx add-mcp https://www.comet.com/opik/api/v1/mcp --name opik-mcp`. Details, troubleshooting and FAQ in the [MCP server guide](https://www.comet.com/docs/opik/mcp-server?utm_source=opik&utm_medium=github&utm_content=mcp_quickstart_link&utm_campaign=opik).
