...
| figma-screen | `figma-screen/` | Generate an Opik screen 1:1 from a Figma frame using the design system — Code Connect mappings, design tokens, and pixel verification. Use when given a Figma frame URL to implement as UI. |
