---
name: share-progress-in-jira
description: Add a progress comment to Jira ticket with git diff summary. Use when updating stakeholders on implementation progress.
---
