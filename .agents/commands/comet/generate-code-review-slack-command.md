---
name: generate-code-review-slack-command
description: Generate a formatted Slack message for #opik-code-review channel. Use when preparing to request code review.
---
